...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeWebPAStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_2f8a4787InstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_2f8a4787{};
            ProxyStub::UnknownProxy* _parameter_2f8a4787Proxy__ = nullptr;
            if (_parameter_2f8a4787InstanceId__ != 0) {
                _parameter_2f8a4787Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_2f8a4787InstanceId__, false, _parameter_2f8a4787);
                ASSERT((_parameter_2f8a4787 != nullptr) && (_parameter_2f8a4787Proxy__ != nullptr));
            }

            uint32_t result = implementation->Initialize(_parameter_2f8a4787);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_2f8a4787Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_2f8a4787Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_f7c755adInstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_f7c755ad{};
            ProxyStub::UnknownProxy* _parameter_f7c755adProxy__ = nullptr;
            if (_parameter_f7c755adInstanceId__ != 0) {
                _parameter_f7c755adProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_f7c755adInstanceId__, false, _parameter_f7c755ad);
                ASSERT((_parameter_f7c755ad != nullptr) && (_parameter_f7c755adProxy__ != nullptr));
            }

            implementation->Deinitialize(_parameter_f7c755ad);

            if (_parameter_f7c755adProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_f7c755adProxy__, message->Response());
            }
        },
    ...
    static ProxyStub::MethodHandler ExchangeWebPAWebPAClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_7ce59a80InstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_7ce59a80{};
            ProxyStub::UnknownProxy* _parameter_7ce59a80Proxy__ = nullptr;
            if (_parameter_7ce59a80InstanceId__ != 0) {
                _parameter_7ce59a80Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_7ce59a80InstanceId__, false, _parameter_7ce59a80);
                ASSERT((_parameter_7ce59a80 != nullptr) && (_parameter_7ce59a80Proxy__ != nullptr));
            }

            uint32_t result = implementation->Configure(_parameter_7ce59a80);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_7ce59a80Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_7ce59a80Proxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Initialize(PluginHost::IShell* _parameter_2f8a4787) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_2f8a4787));
        ...
        void Deinitialize(PluginHost::IShell* _parameter_f7c755ad) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_f7c755ad));
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_7ce59a80) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_7ce59a80));
