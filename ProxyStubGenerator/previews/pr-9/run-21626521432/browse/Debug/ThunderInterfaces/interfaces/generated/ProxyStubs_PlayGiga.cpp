...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangePlayGigaStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            const string _parameter_173c1acc = reader.Text();
            const string _parameter_1f9c8975 = reader.Text();

            implementation->Launch(static_cast<const string&>(_parameter_173c1acc), static_cast<const string&>(_parameter_1f9c8975));
        }
        , nullptr
    ...
    public:
        ...
        void Launch(const string& _parameter_173c1acc, const string& _parameter_1f9c8975) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_173c1acc);
            writer.Text(_parameter_1f9c8975);
