...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeStreamStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_b6cdf86fInstanceId__ = reader.Number<Core::instance_id>();

            Exchange::IStream::ICallback* _parameter_b6cdf86f{};
            ProxyStub::UnknownProxy* _parameter_b6cdf86fProxy__ = nullptr;
            if (_parameter_b6cdf86fInstanceId__ != 0) {
                _parameter_b6cdf86fProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_b6cdf86fInstanceId__, false, _parameter_b6cdf86f);
                ASSERT((_parameter_b6cdf86f != nullptr) && (_parameter_b6cdf86fProxy__ != nullptr));
            }

            implementation->Callback(_parameter_b6cdf86f);

            if (_parameter_b6cdf86fProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_b6cdf86fProxy__, message->Response());
            }
        },
    ...
    public:
        ...
        void Callback(Exchange::IStream::ICallback* _parameter_b6cdf86f) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(4));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_b6cdf86f));
