...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeDolbyOutputStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_1adfc45bInstanceId__ = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_1adfc45b{};
            ProxyStub::UnknownProxy* _parameter_1adfc45bProxy__ = nullptr;
            if (_parameter_1adfc45bInstanceId__ != 0) {
                _parameter_1adfc45bProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_1adfc45bInstanceId__, false, _parameter_1adfc45b);
                ASSERT((_parameter_1adfc45b != nullptr) && (_parameter_1adfc45bProxy__ != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_1adfc45b);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_1adfc45bProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_1adfc45bProxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_92b07ec7InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_92b07ec7{};
            ProxyStub::UnknownProxy* _parameter_92b07ec7Proxy__ = nullptr;
            if (_parameter_92b07ec7InstanceId__ != 0) {
                _parameter_92b07ec7Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_92b07ec7InstanceId__, false, _parameter_92b07ec7);
                ASSERT((_parameter_92b07ec7 != nullptr) && (_parameter_92b07ec7Proxy__ != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_92b07ec7);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_92b07ec7Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_92b07ec7Proxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Register(Exchange::Dolby::IOutput::INotification* _parameter_1adfc45b) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_1adfc45b));
        ...
        uint32_t Unregister(Exchange::Dolby::IOutput::INotification* _parameter_92b07ec7) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_92b07ec7));
