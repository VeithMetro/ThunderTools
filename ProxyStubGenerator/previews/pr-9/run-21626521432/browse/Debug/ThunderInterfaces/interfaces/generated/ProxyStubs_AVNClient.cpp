...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeAVNClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_03b76199InstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_03b76199{};
            ProxyStub::UnknownProxy* _parameter_03b76199Proxy__ = nullptr;
            if (_parameter_03b76199InstanceId__ != 0) {
                _parameter_03b76199Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_03b76199InstanceId__, false, _parameter_03b76199);
                ASSERT((_parameter_03b76199 != nullptr) && (_parameter_03b76199Proxy__ != nullptr));
            }

            uint32_t result = implementation->Configure(_parameter_03b76199);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_03b76199Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_03b76199Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const string _parameter_701a3253 = reader.Text();

            implementation->Launch(static_cast<const string&>(_parameter_701a3253));
        }
        , nullptr
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_03b76199) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_03b76199));
        ...
        void Launch(const string& _parameter_701a3253) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_701a3253);
