...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler RemoteConnectionNotificationStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_5f67de6aInstanceId__ = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_5f67de6a{};
            ProxyStub::UnknownProxy* _parameter_5f67de6aProxy__ = nullptr;
            if (_parameter_5f67de6aInstanceId__ != 0) {
                _parameter_5f67de6aProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_5f67de6aInstanceId__, false, _parameter_5f67de6a);
                ASSERT((_parameter_5f67de6a != nullptr) && (_parameter_5f67de6aProxy__ != nullptr));
            }

            implementation->Activated(_parameter_5f67de6a);

            if (_parameter_5f67de6aProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_5f67de6aProxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_9bf5d4a8InstanceId__ = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_9bf5d4a8{};
            ProxyStub::UnknownProxy* _parameter_9bf5d4a8Proxy__ = nullptr;
            if (_parameter_9bf5d4a8InstanceId__ != 0) {
                _parameter_9bf5d4a8Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_9bf5d4a8InstanceId__, false, _parameter_9bf5d4a8);
                ASSERT((_parameter_9bf5d4a8 != nullptr) && (_parameter_9bf5d4a8Proxy__ != nullptr));
            }

            implementation->Deactivated(_parameter_9bf5d4a8);

            if (_parameter_9bf5d4a8Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_9bf5d4a8Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_3275bb73InstanceId__ = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_3275bb73{};
            ProxyStub::UnknownProxy* _parameter_3275bb73Proxy__ = nullptr;
            if (_parameter_3275bb73InstanceId__ != 0) {
                _parameter_3275bb73Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_3275bb73InstanceId__, false, _parameter_3275bb73);
                ASSERT((_parameter_3275bb73 != nullptr) && (_parameter_3275bb73Proxy__ != nullptr));
            }

            implementation->Terminated(_parameter_3275bb73);

            if (_parameter_3275bb73Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_3275bb73Proxy__, message->Response());
            }
        }
        , nullptr
    ...
    public:
        ...
        void Activated(IRemoteConnection* _parameter_5f67de6a) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_5f67de6a));
        ...
        void Deactivated(IRemoteConnection* _parameter_9bf5d4a8) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_9bf5d4a8));
        ...
        void Terminated(IRemoteConnection* _parameter_3275bb73) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(2));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_3275bb73));
