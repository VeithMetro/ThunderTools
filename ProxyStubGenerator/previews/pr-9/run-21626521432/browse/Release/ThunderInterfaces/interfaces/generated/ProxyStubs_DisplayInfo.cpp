...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeConnectionPropertiesStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_0c68f31cInstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IConnectionProperties::INotification* _parameter_0c68f31c{};
                ProxyStub::UnknownProxy* _parameter_0c68f31cProxy__ = nullptr;
                if (_parameter_0c68f31cInstanceId__ != 0) {
                    _parameter_0c68f31cProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_0c68f31cInstanceId__, false, _parameter_0c68f31c);
                    ASSERT((_parameter_0c68f31c != nullptr) && (_parameter_0c68f31cProxy__ != nullptr));
                    if ((_parameter_0c68f31c == nullptr) || (_parameter_0c68f31cProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Register(_parameter_0c68f31c);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_0c68f31cProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_0c68f31cProxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_bd27ee23InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IConnectionProperties::INotification* _parameter_bd27ee23{};
                ProxyStub::UnknownProxy* _parameter_bd27ee23Proxy__ = nullptr;
                if (_parameter_bd27ee23InstanceId__ != 0) {
                    _parameter_bd27ee23Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_bd27ee23InstanceId__, false, _parameter_bd27ee23);
                    ASSERT((_parameter_bd27ee23 != nullptr) && (_parameter_bd27ee23Proxy__ != nullptr));
                    if ((_parameter_bd27ee23 == nullptr) || (_parameter_bd27ee23Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Unregister(_parameter_bd27ee23);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_bd27ee23Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_bd27ee23Proxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Register(Exchange::IConnectionProperties::INotification* _parameter_0c68f31c) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_0c68f31c));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_0c68f31c), Exchange::IConnectionProperties::INotification::ID }, { 0, 0 } };
        ...
        uint32_t Unregister(Exchange::IConnectionProperties::INotification* _parameter_bd27ee23) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_bd27ee23));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_bd27ee23), Exchange::IConnectionProperties::INotification::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
