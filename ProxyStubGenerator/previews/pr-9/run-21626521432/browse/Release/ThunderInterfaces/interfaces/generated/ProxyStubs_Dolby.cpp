...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeDolbyOutputStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_c574b1ceInstanceId__ = reader.Number<Core::instance_id>();

                Exchange::Dolby::IOutput::INotification* _parameter_c574b1ce{};
                ProxyStub::UnknownProxy* _parameter_c574b1ceProxy__ = nullptr;
                if (_parameter_c574b1ceInstanceId__ != 0) {
                    _parameter_c574b1ceProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_c574b1ceInstanceId__, false, _parameter_c574b1ce);
                    ASSERT((_parameter_c574b1ce != nullptr) && (_parameter_c574b1ceProxy__ != nullptr));
                    if ((_parameter_c574b1ce == nullptr) || (_parameter_c574b1ceProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Register(_parameter_c574b1ce);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_c574b1ceProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_c574b1ceProxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_e08d6b75InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::Dolby::IOutput::INotification* _parameter_e08d6b75{};
                ProxyStub::UnknownProxy* _parameter_e08d6b75Proxy__ = nullptr;
                if (_parameter_e08d6b75InstanceId__ != 0) {
                    _parameter_e08d6b75Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_e08d6b75InstanceId__, false, _parameter_e08d6b75);
                    ASSERT((_parameter_e08d6b75 != nullptr) && (_parameter_e08d6b75Proxy__ != nullptr));
                    if ((_parameter_e08d6b75 == nullptr) || (_parameter_e08d6b75Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Unregister(_parameter_e08d6b75);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_e08d6b75Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_e08d6b75Proxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Register(Exchange::Dolby::IOutput::INotification* _parameter_c574b1ce) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_c574b1ce));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_c574b1ce), Exchange::Dolby::IOutput::INotification::ID }, { 0, 0 } };
        ...
        uint32_t Unregister(Exchange::Dolby::IOutput::INotification* _parameter_e08d6b75) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_e08d6b75));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_e08d6b75), Exchange::Dolby::IOutput::INotification::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
