...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeWebPAStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_c27ecc32InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_c27ecc32{};
                ProxyStub::UnknownProxy* _parameter_c27ecc32Proxy__ = nullptr;
                if (_parameter_c27ecc32InstanceId__ != 0) {
                    _parameter_c27ecc32Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_c27ecc32InstanceId__, false, _parameter_c27ecc32);
                    ASSERT((_parameter_c27ecc32 != nullptr) && (_parameter_c27ecc32Proxy__ != nullptr));
                    if ((_parameter_c27ecc32 == nullptr) || (_parameter_c27ecc32Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Initialize(_parameter_c27ecc32);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_c27ecc32Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_c27ecc32Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_75490b4cInstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_75490b4c{};
                ProxyStub::UnknownProxy* _parameter_75490b4cProxy__ = nullptr;
                if (_parameter_75490b4cInstanceId__ != 0) {
                    _parameter_75490b4cProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_75490b4cInstanceId__, false, _parameter_75490b4c);
                    ASSERT((_parameter_75490b4c != nullptr) && (_parameter_75490b4cProxy__ != nullptr));
                    if ((_parameter_75490b4c == nullptr) || (_parameter_75490b4cProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Deinitialize(_parameter_75490b4c);

                if (_parameter_75490b4cProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_75490b4cProxy__, message->Response());
                }
    ...
    static ProxyStub::MethodHandler ExchangeWebPAWebPAClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_b1f29e97InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_b1f29e97{};
                ProxyStub::UnknownProxy* _parameter_b1f29e97Proxy__ = nullptr;
                if (_parameter_b1f29e97InstanceId__ != 0) {
                    _parameter_b1f29e97Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_b1f29e97InstanceId__, false, _parameter_b1f29e97);
                    ASSERT((_parameter_b1f29e97 != nullptr) && (_parameter_b1f29e97Proxy__ != nullptr));
                    if ((_parameter_b1f29e97 == nullptr) || (_parameter_b1f29e97Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Configure(_parameter_b1f29e97);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_b1f29e97Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_b1f29e97Proxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Initialize(PluginHost::IShell* _parameter_c27ecc32) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_c27ecc32));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_c27ecc32), PluginHost::IShell::ID }, { 0, 0 } };
        ...
        void Deinitialize(PluginHost::IShell* _parameter_75490b4c) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_75490b4c));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_75490b4c), PluginHost::IShell::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_b1f29e97) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_b1f29e97));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_b1f29e97), PluginHost::IShell::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
