...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeStreamStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_cbdf0e2bInstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IStream::ICallback* _parameter_cbdf0e2b{};
                ProxyStub::UnknownProxy* _parameter_cbdf0e2bProxy__ = nullptr;
                if (_parameter_cbdf0e2bInstanceId__ != 0) {
                    _parameter_cbdf0e2bProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_cbdf0e2bInstanceId__, false, _parameter_cbdf0e2b);
                    ASSERT((_parameter_cbdf0e2b != nullptr) && (_parameter_cbdf0e2bProxy__ != nullptr));
                    if ((_parameter_cbdf0e2b == nullptr) || (_parameter_cbdf0e2bProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Callback(_parameter_cbdf0e2b);

                if (_parameter_cbdf0e2bProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_cbdf0e2bProxy__, message->Response());
                }
    ...
    public:
        ...
        void Callback(Exchange::IStream::ICallback* _parameter_cbdf0e2b) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(4));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_cbdf0e2b));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_cbdf0e2b), Exchange::IStream::ICallback::ID }, { 0, 0 } };
