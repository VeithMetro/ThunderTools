...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler RemoteConnectionNotificationStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_36f0529dInstanceId__ = reader.Number<Core::instance_id>();

                IRemoteConnection* _parameter_36f0529d{};
                ProxyStub::UnknownProxy* _parameter_36f0529dProxy__ = nullptr;
                if (_parameter_36f0529dInstanceId__ != 0) {
                    _parameter_36f0529dProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_36f0529dInstanceId__, false, _parameter_36f0529d);
                    ASSERT((_parameter_36f0529d != nullptr) && (_parameter_36f0529dProxy__ != nullptr));
                    if ((_parameter_36f0529d == nullptr) || (_parameter_36f0529dProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Activated(_parameter_36f0529d);

                if (_parameter_36f0529dProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_36f0529dProxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_a5e41ab6InstanceId__ = reader.Number<Core::instance_id>();

                IRemoteConnection* _parameter_a5e41ab6{};
                ProxyStub::UnknownProxy* _parameter_a5e41ab6Proxy__ = nullptr;
                if (_parameter_a5e41ab6InstanceId__ != 0) {
                    _parameter_a5e41ab6Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_a5e41ab6InstanceId__, false, _parameter_a5e41ab6);
                    ASSERT((_parameter_a5e41ab6 != nullptr) && (_parameter_a5e41ab6Proxy__ != nullptr));
                    if ((_parameter_a5e41ab6 == nullptr) || (_parameter_a5e41ab6Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Deactivated(_parameter_a5e41ab6);

                if (_parameter_a5e41ab6Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_a5e41ab6Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_1b3434dfInstanceId__ = reader.Number<Core::instance_id>();

                IRemoteConnection* _parameter_1b3434df{};
                ProxyStub::UnknownProxy* _parameter_1b3434dfProxy__ = nullptr;
                if (_parameter_1b3434dfInstanceId__ != 0) {
                    _parameter_1b3434dfProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_1b3434dfInstanceId__, false, _parameter_1b3434df);
                    ASSERT((_parameter_1b3434df != nullptr) && (_parameter_1b3434dfProxy__ != nullptr));
                    if ((_parameter_1b3434df == nullptr) || (_parameter_1b3434dfProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Terminated(_parameter_1b3434df);

                if (_parameter_1b3434dfProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_1b3434dfProxy__, message->Response());
                }
    ...
    public:
        ...
        void Activated(IRemoteConnection* _parameter_36f0529d) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_36f0529d));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_36f0529d), IRemoteConnection::ID }, { 0, 0 } };
        ...
        void Deactivated(IRemoteConnection* _parameter_a5e41ab6) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_a5e41ab6));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_a5e41ab6), IRemoteConnection::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
        ...
        void Terminated(IRemoteConnection* _parameter_1b3434df) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(2));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_1b3434df));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_1b3434df), IRemoteConnection::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
