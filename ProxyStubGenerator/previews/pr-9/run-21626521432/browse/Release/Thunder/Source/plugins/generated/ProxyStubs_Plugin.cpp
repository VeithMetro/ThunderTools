...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler CompositPluginStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_92d1f2ebInstanceId__ = reader.Number<Core::instance_id>();

                ICompositPlugin::ICallback* _parameter_92d1f2eb{};
                ProxyStub::UnknownProxy* _parameter_92d1f2ebProxy__ = nullptr;
                if (_parameter_92d1f2ebInstanceId__ != 0) {
                    _parameter_92d1f2ebProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_92d1f2ebInstanceId__, false, _parameter_92d1f2eb);
                    ASSERT((_parameter_92d1f2eb != nullptr) && (_parameter_92d1f2ebProxy__ != nullptr));
                    if ((_parameter_92d1f2eb == nullptr) || (_parameter_92d1f2ebProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Callback(_parameter_92d1f2eb);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_92d1f2ebProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_92d1f2ebProxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Callback(ICompositPlugin::ICallback* _parameter_92d1f2eb) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_92d1f2eb));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_92d1f2eb), ICompositPlugin::ICallback::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
