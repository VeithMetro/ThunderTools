...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ShellStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const IShell::reason _parameter_b299d6a8 = reader.Number<IShell::reason>();

            Core::hresult result = implementation->Activate(_parameter_b299d6a8);
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const IShell::reason _parameter_283fc5ae = reader.Number<IShell::reason>();

            Core::hresult result = implementation->Deactivate(_parameter_283fc5ae);
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const IShell::reason _parameter_8fc353b5 = reader.Number<IShell::reason>();

            Core::hresult result = implementation->Unavailable(_parameter_8fc353b5);
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const string _parameter_580998b0 = reader.Text();

            RPC::IStringIterator* result = implementation->GetLibrarySearchPaths(static_cast<const string&>(_parameter_580998b0));
    ...
    public:
        ...
        Core::hresult Activate(const IShell::reason _parameter_b299d6a8) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(32));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<IShell::reason>(_parameter_b299d6a8);
        ...
        Core::hresult Deactivate(const IShell::reason _parameter_283fc5ae) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(33));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<IShell::reason>(_parameter_283fc5ae);
        ...
        Core::hresult Unavailable(const IShell::reason _parameter_8fc353b5) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(34));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<IShell::reason>(_parameter_8fc353b5);
        ...
        RPC::IStringIterator* GetLibrarySearchPaths(const string& _parameter_580998b0) const override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(38));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_580998b0);
