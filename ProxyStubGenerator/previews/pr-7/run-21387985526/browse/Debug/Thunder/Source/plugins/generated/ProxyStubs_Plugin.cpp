...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler CompositPluginStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_2b55d25fInstanceId__ = reader.Number<Core::instance_id>();

            ICompositPlugin::ICallback* _parameter_2b55d25f{};
            ProxyStub::UnknownProxy* _parameter_2b55d25fProxy__ = nullptr;
            if (_parameter_2b55d25fInstanceId__ != 0) {
                _parameter_2b55d25fProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_2b55d25fInstanceId__, false, _parameter_2b55d25f);
                ASSERT((_parameter_2b55d25f != nullptr) && (_parameter_2b55d25fProxy__ != nullptr));
            }

            uint32_t result = implementation->Callback(_parameter_2b55d25f);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_2b55d25fProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_2b55d25fProxy__, message->Response());
            }
        }
        , nullptr
    ...
    public:
        ...
        uint32_t Callback(ICompositPlugin::ICallback* _parameter_2b55d25f) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_2b55d25f));
