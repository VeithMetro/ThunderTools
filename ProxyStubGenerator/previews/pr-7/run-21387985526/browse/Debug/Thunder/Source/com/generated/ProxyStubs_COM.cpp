...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler RemoteConnectionNotificationStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_94c68b56InstanceId__ = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_94c68b56{};
            ProxyStub::UnknownProxy* _parameter_94c68b56Proxy__ = nullptr;
            if (_parameter_94c68b56InstanceId__ != 0) {
                _parameter_94c68b56Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_94c68b56InstanceId__, false, _parameter_94c68b56);
                ASSERT((_parameter_94c68b56 != nullptr) && (_parameter_94c68b56Proxy__ != nullptr));
            }

            implementation->Activated(_parameter_94c68b56);

            if (_parameter_94c68b56Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_94c68b56Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_a24dd5afInstanceId__ = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_a24dd5af{};
            ProxyStub::UnknownProxy* _parameter_a24dd5afProxy__ = nullptr;
            if (_parameter_a24dd5afInstanceId__ != 0) {
                _parameter_a24dd5afProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_a24dd5afInstanceId__, false, _parameter_a24dd5af);
                ASSERT((_parameter_a24dd5af != nullptr) && (_parameter_a24dd5afProxy__ != nullptr));
            }

            implementation->Deactivated(_parameter_a24dd5af);

            if (_parameter_a24dd5afProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_a24dd5afProxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_bee4071eInstanceId__ = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_bee4071e{};
            ProxyStub::UnknownProxy* _parameter_bee4071eProxy__ = nullptr;
            if (_parameter_bee4071eInstanceId__ != 0) {
                _parameter_bee4071eProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_bee4071eInstanceId__, false, _parameter_bee4071e);
                ASSERT((_parameter_bee4071e != nullptr) && (_parameter_bee4071eProxy__ != nullptr));
            }

            implementation->Terminated(_parameter_bee4071e);

            if (_parameter_bee4071eProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_bee4071eProxy__, message->Response());
            }
        }
        , nullptr
    ...
    public:
        ...
        void Activated(IRemoteConnection* _parameter_94c68b56) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_94c68b56));
        ...
        void Deactivated(IRemoteConnection* _parameter_a24dd5af) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_a24dd5af));
        ...
        void Terminated(IRemoteConnection* _parameter_bee4071e) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(2));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_bee4071e));
