...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeDolbyOutputStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_46a5fad1InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_46a5fad1{};
            ProxyStub::UnknownProxy* _parameter_46a5fad1Proxy__ = nullptr;
            if (_parameter_46a5fad1InstanceId__ != 0) {
                _parameter_46a5fad1Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_46a5fad1InstanceId__, false, _parameter_46a5fad1);
                ASSERT((_parameter_46a5fad1 != nullptr) && (_parameter_46a5fad1Proxy__ != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_46a5fad1);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_46a5fad1Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_46a5fad1Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_4c716f18InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_4c716f18{};
            ProxyStub::UnknownProxy* _parameter_4c716f18Proxy__ = nullptr;
            if (_parameter_4c716f18InstanceId__ != 0) {
                _parameter_4c716f18Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_4c716f18InstanceId__, false, _parameter_4c716f18);
                ASSERT((_parameter_4c716f18 != nullptr) && (_parameter_4c716f18Proxy__ != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_4c716f18);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_4c716f18Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_4c716f18Proxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Register(Exchange::Dolby::IOutput::INotification* _parameter_46a5fad1) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_46a5fad1));
        ...
        uint32_t Unregister(Exchange::Dolby::IOutput::INotification* _parameter_4c716f18) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_4c716f18));
