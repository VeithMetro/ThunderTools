...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangePlayGigaStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            const string _parameter_2d561e22 = reader.Text();
            const string _parameter_b99783f8 = reader.Text();

            implementation->Launch(static_cast<const string&>(_parameter_2d561e22), static_cast<const string&>(_parameter_b99783f8));
        }
        , nullptr
    ...
    public:
        ...
        void Launch(const string& _parameter_2d561e22, const string& _parameter_b99783f8) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_2d561e22);
            writer.Text(_parameter_b99783f8);
