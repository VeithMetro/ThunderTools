...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeWebPAStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_b73b83dbInstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_b73b83db{};
            ProxyStub::UnknownProxy* _parameter_b73b83dbProxy__ = nullptr;
            if (_parameter_b73b83dbInstanceId__ != 0) {
                _parameter_b73b83dbProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_b73b83dbInstanceId__, false, _parameter_b73b83db);
                ASSERT((_parameter_b73b83db != nullptr) && (_parameter_b73b83dbProxy__ != nullptr));
            }

            uint32_t result = implementation->Initialize(_parameter_b73b83db);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_b73b83dbProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_b73b83dbProxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_9ec56011InstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_9ec56011{};
            ProxyStub::UnknownProxy* _parameter_9ec56011Proxy__ = nullptr;
            if (_parameter_9ec56011InstanceId__ != 0) {
                _parameter_9ec56011Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_9ec56011InstanceId__, false, _parameter_9ec56011);
                ASSERT((_parameter_9ec56011 != nullptr) && (_parameter_9ec56011Proxy__ != nullptr));
            }

            implementation->Deinitialize(_parameter_9ec56011);

            if (_parameter_9ec56011Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_9ec56011Proxy__, message->Response());
            }
        },
    ...
    static ProxyStub::MethodHandler ExchangeWebPAWebPAClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_56a8e1fbInstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_56a8e1fb{};
            ProxyStub::UnknownProxy* _parameter_56a8e1fbProxy__ = nullptr;
            if (_parameter_56a8e1fbInstanceId__ != 0) {
                _parameter_56a8e1fbProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_56a8e1fbInstanceId__, false, _parameter_56a8e1fb);
                ASSERT((_parameter_56a8e1fb != nullptr) && (_parameter_56a8e1fbProxy__ != nullptr));
            }

            uint32_t result = implementation->Configure(_parameter_56a8e1fb);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_56a8e1fbProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_56a8e1fbProxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Initialize(PluginHost::IShell* _parameter_b73b83db) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_b73b83db));
        ...
        void Deinitialize(PluginHost::IShell* _parameter_9ec56011) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_9ec56011));
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_56a8e1fb) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_56a8e1fb));
