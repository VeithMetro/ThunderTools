...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeStreamStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_d0996e5eInstanceId__ = reader.Number<Core::instance_id>();

            Exchange::IStream::ICallback* _parameter_d0996e5e{};
            ProxyStub::UnknownProxy* _parameter_d0996e5eProxy__ = nullptr;
            if (_parameter_d0996e5eInstanceId__ != 0) {
                _parameter_d0996e5eProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_d0996e5eInstanceId__, false, _parameter_d0996e5e);
                ASSERT((_parameter_d0996e5e != nullptr) && (_parameter_d0996e5eProxy__ != nullptr));
            }

            implementation->Callback(_parameter_d0996e5e);

            if (_parameter_d0996e5eProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_d0996e5eProxy__, message->Response());
            }
        },
    ...
    public:
        ...
        void Callback(Exchange::IStream::ICallback* _parameter_d0996e5e) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(4));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_d0996e5e));
