...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeConnectionPropertiesStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_e18b76f6InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_e18b76f6{};
            ProxyStub::UnknownProxy* _parameter_e18b76f6Proxy__ = nullptr;
            if (_parameter_e18b76f6InstanceId__ != 0) {
                _parameter_e18b76f6Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_e18b76f6InstanceId__, false, _parameter_e18b76f6);
                ASSERT((_parameter_e18b76f6 != nullptr) && (_parameter_e18b76f6Proxy__ != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_e18b76f6);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_e18b76f6Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_e18b76f6Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_4e3b897bInstanceId__ = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_4e3b897b{};
            ProxyStub::UnknownProxy* _parameter_4e3b897bProxy__ = nullptr;
            if (_parameter_4e3b897bInstanceId__ != 0) {
                _parameter_4e3b897bProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_4e3b897bInstanceId__, false, _parameter_4e3b897b);
                ASSERT((_parameter_4e3b897b != nullptr) && (_parameter_4e3b897bProxy__ != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_4e3b897b);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_4e3b897bProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_4e3b897bProxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Register(Exchange::IConnectionProperties::INotification* _parameter_e18b76f6) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_e18b76f6));
        ...
        uint32_t Unregister(Exchange::IConnectionProperties::INotification* _parameter_4e3b897b) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_4e3b897b));
