...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler RemoteConnectionNotificationStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_bad4cf68InstanceId__ = reader.Number<Core::instance_id>();

                IRemoteConnection* _parameter_bad4cf68{};
                ProxyStub::UnknownProxy* _parameter_bad4cf68Proxy__ = nullptr;
                if (_parameter_bad4cf68InstanceId__ != 0) {
                    _parameter_bad4cf68Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_bad4cf68InstanceId__, false, _parameter_bad4cf68);
                    ASSERT((_parameter_bad4cf68 != nullptr) && (_parameter_bad4cf68Proxy__ != nullptr));
                    if ((_parameter_bad4cf68 == nullptr) || (_parameter_bad4cf68Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Activated(_parameter_bad4cf68);

                if (_parameter_bad4cf68Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_bad4cf68Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_c8e40a84InstanceId__ = reader.Number<Core::instance_id>();

                IRemoteConnection* _parameter_c8e40a84{};
                ProxyStub::UnknownProxy* _parameter_c8e40a84Proxy__ = nullptr;
                if (_parameter_c8e40a84InstanceId__ != 0) {
                    _parameter_c8e40a84Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_c8e40a84InstanceId__, false, _parameter_c8e40a84);
                    ASSERT((_parameter_c8e40a84 != nullptr) && (_parameter_c8e40a84Proxy__ != nullptr));
                    if ((_parameter_c8e40a84 == nullptr) || (_parameter_c8e40a84Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Deactivated(_parameter_c8e40a84);

                if (_parameter_c8e40a84Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_c8e40a84Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_bf234b7cInstanceId__ = reader.Number<Core::instance_id>();

                IRemoteConnection* _parameter_bf234b7c{};
                ProxyStub::UnknownProxy* _parameter_bf234b7cProxy__ = nullptr;
                if (_parameter_bf234b7cInstanceId__ != 0) {
                    _parameter_bf234b7cProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_bf234b7cInstanceId__, false, _parameter_bf234b7c);
                    ASSERT((_parameter_bf234b7c != nullptr) && (_parameter_bf234b7cProxy__ != nullptr));
                    if ((_parameter_bf234b7c == nullptr) || (_parameter_bf234b7cProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Terminated(_parameter_bf234b7c);

                if (_parameter_bf234b7cProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_bf234b7cProxy__, message->Response());
                }
    ...
    public:
        ...
        void Activated(IRemoteConnection* _parameter_bad4cf68) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_bad4cf68));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_bad4cf68), IRemoteConnection::ID }, { 0, 0 } };
        ...
        void Deactivated(IRemoteConnection* _parameter_c8e40a84) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_c8e40a84));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_c8e40a84), IRemoteConnection::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
        ...
        void Terminated(IRemoteConnection* _parameter_bf234b7c) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(2));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_bf234b7c));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_bf234b7c), IRemoteConnection::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
