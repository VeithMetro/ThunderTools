...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeDolbyOutputStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_60a7364aInstanceId__ = reader.Number<Core::instance_id>();

                Exchange::Dolby::IOutput::INotification* _parameter_60a7364a{};
                ProxyStub::UnknownProxy* _parameter_60a7364aProxy__ = nullptr;
                if (_parameter_60a7364aInstanceId__ != 0) {
                    _parameter_60a7364aProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_60a7364aInstanceId__, false, _parameter_60a7364a);
                    ASSERT((_parameter_60a7364a != nullptr) && (_parameter_60a7364aProxy__ != nullptr));
                    if ((_parameter_60a7364a == nullptr) || (_parameter_60a7364aProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Register(_parameter_60a7364a);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_60a7364aProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_60a7364aProxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_39180ef5InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::Dolby::IOutput::INotification* _parameter_39180ef5{};
                ProxyStub::UnknownProxy* _parameter_39180ef5Proxy__ = nullptr;
                if (_parameter_39180ef5InstanceId__ != 0) {
                    _parameter_39180ef5Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_39180ef5InstanceId__, false, _parameter_39180ef5);
                    ASSERT((_parameter_39180ef5 != nullptr) && (_parameter_39180ef5Proxy__ != nullptr));
                    if ((_parameter_39180ef5 == nullptr) || (_parameter_39180ef5Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Unregister(_parameter_39180ef5);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_39180ef5Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_39180ef5Proxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Register(Exchange::Dolby::IOutput::INotification* _parameter_60a7364a) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_60a7364a));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_60a7364a), Exchange::Dolby::IOutput::INotification::ID }, { 0, 0 } };
        ...
        uint32_t Unregister(Exchange::Dolby::IOutput::INotification* _parameter_39180ef5) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_39180ef5));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_39180ef5), Exchange::Dolby::IOutput::INotification::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
