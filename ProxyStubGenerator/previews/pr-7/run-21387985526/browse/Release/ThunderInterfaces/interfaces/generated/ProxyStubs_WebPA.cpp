...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeWebPAStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_5c14d594InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_5c14d594{};
                ProxyStub::UnknownProxy* _parameter_5c14d594Proxy__ = nullptr;
                if (_parameter_5c14d594InstanceId__ != 0) {
                    _parameter_5c14d594Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_5c14d594InstanceId__, false, _parameter_5c14d594);
                    ASSERT((_parameter_5c14d594 != nullptr) && (_parameter_5c14d594Proxy__ != nullptr));
                    if ((_parameter_5c14d594 == nullptr) || (_parameter_5c14d594Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Initialize(_parameter_5c14d594);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_5c14d594Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_5c14d594Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_ed26690eInstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_ed26690e{};
                ProxyStub::UnknownProxy* _parameter_ed26690eProxy__ = nullptr;
                if (_parameter_ed26690eInstanceId__ != 0) {
                    _parameter_ed26690eProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_ed26690eInstanceId__, false, _parameter_ed26690e);
                    ASSERT((_parameter_ed26690e != nullptr) && (_parameter_ed26690eProxy__ != nullptr));
                    if ((_parameter_ed26690e == nullptr) || (_parameter_ed26690eProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Deinitialize(_parameter_ed26690e);

                if (_parameter_ed26690eProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_ed26690eProxy__, message->Response());
                }
    ...
    static ProxyStub::MethodHandler ExchangeWebPAWebPAClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_c3d58503InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_c3d58503{};
                ProxyStub::UnknownProxy* _parameter_c3d58503Proxy__ = nullptr;
                if (_parameter_c3d58503InstanceId__ != 0) {
                    _parameter_c3d58503Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_c3d58503InstanceId__, false, _parameter_c3d58503);
                    ASSERT((_parameter_c3d58503 != nullptr) && (_parameter_c3d58503Proxy__ != nullptr));
                    if ((_parameter_c3d58503 == nullptr) || (_parameter_c3d58503Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Configure(_parameter_c3d58503);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_c3d58503Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_c3d58503Proxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Initialize(PluginHost::IShell* _parameter_5c14d594) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_5c14d594));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_5c14d594), PluginHost::IShell::ID }, { 0, 0 } };
        ...
        void Deinitialize(PluginHost::IShell* _parameter_ed26690e) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_ed26690e));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_ed26690e), PluginHost::IShell::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_c3d58503) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_c3d58503));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_c3d58503), PluginHost::IShell::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
