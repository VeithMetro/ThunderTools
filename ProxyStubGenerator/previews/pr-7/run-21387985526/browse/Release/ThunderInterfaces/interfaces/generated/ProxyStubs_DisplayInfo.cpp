...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeConnectionPropertiesStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_345af104InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IConnectionProperties::INotification* _parameter_345af104{};
                ProxyStub::UnknownProxy* _parameter_345af104Proxy__ = nullptr;
                if (_parameter_345af104InstanceId__ != 0) {
                    _parameter_345af104Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_345af104InstanceId__, false, _parameter_345af104);
                    ASSERT((_parameter_345af104 != nullptr) && (_parameter_345af104Proxy__ != nullptr));
                    if ((_parameter_345af104 == nullptr) || (_parameter_345af104Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Register(_parameter_345af104);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_345af104Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_345af104Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_0794d2daInstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IConnectionProperties::INotification* _parameter_0794d2da{};
                ProxyStub::UnknownProxy* _parameter_0794d2daProxy__ = nullptr;
                if (_parameter_0794d2daInstanceId__ != 0) {
                    _parameter_0794d2daProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_0794d2daInstanceId__, false, _parameter_0794d2da);
                    ASSERT((_parameter_0794d2da != nullptr) && (_parameter_0794d2daProxy__ != nullptr));
                    if ((_parameter_0794d2da == nullptr) || (_parameter_0794d2daProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Unregister(_parameter_0794d2da);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_0794d2daProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_0794d2daProxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Register(Exchange::IConnectionProperties::INotification* _parameter_345af104) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_345af104));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_345af104), Exchange::IConnectionProperties::INotification::ID }, { 0, 0 } };
        ...
        uint32_t Unregister(Exchange::IConnectionProperties::INotification* _parameter_0794d2da) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_0794d2da));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_0794d2da), Exchange::IConnectionProperties::INotification::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
