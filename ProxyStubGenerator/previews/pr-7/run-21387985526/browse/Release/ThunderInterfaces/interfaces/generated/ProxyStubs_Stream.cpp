...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeStreamStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_f01b8faaInstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IStream::ICallback* _parameter_f01b8faa{};
                ProxyStub::UnknownProxy* _parameter_f01b8faaProxy__ = nullptr;
                if (_parameter_f01b8faaInstanceId__ != 0) {
                    _parameter_f01b8faaProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_f01b8faaInstanceId__, false, _parameter_f01b8faa);
                    ASSERT((_parameter_f01b8faa != nullptr) && (_parameter_f01b8faaProxy__ != nullptr));
                    if ((_parameter_f01b8faa == nullptr) || (_parameter_f01b8faaProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Callback(_parameter_f01b8faa);

                if (_parameter_f01b8faaProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_f01b8faaProxy__, message->Response());
                }
    ...
    public:
        ...
        void Callback(Exchange::IStream::ICallback* _parameter_f01b8faa) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(4));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_f01b8faa));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_f01b8faa), Exchange::IStream::ICallback::ID }, { 0, 0 } };
