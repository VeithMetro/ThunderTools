...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeAVNClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_481d221fInstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_481d221f{};
            ProxyStub::UnknownProxy* _parameter_481d221fProxy__ = nullptr;
            if (_parameter_481d221fInstanceId__ != 0) {
                _parameter_481d221fProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_481d221fInstanceId__, false, _parameter_481d221f);
                ASSERT((_parameter_481d221f != nullptr) && (_parameter_481d221fProxy__ != nullptr));
            }

            uint32_t result = implementation->Configure(_parameter_481d221f);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_481d221fProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_481d221fProxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const string _parameter_0b80f72b = reader.Text();

            implementation->Launch(static_cast<const string&>(_parameter_0b80f72b));
        }
        , nullptr
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_481d221f) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_481d221f));
        ...
        void Launch(const string& _parameter_0b80f72b) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_0b80f72b);
