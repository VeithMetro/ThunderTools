...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeStreamStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_896fa94cInstanceId__ = reader.Number<Core::instance_id>();

            Exchange::IStream::ICallback* _parameter_896fa94c{};
            ProxyStub::UnknownProxy* _parameter_896fa94cProxy__ = nullptr;
            if (_parameter_896fa94cInstanceId__ != 0) {
                _parameter_896fa94cProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_896fa94cInstanceId__, false, _parameter_896fa94c);
                ASSERT((_parameter_896fa94c != nullptr) && (_parameter_896fa94cProxy__ != nullptr));
            }

            implementation->Callback(_parameter_896fa94c);

            if (_parameter_896fa94cProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_896fa94cProxy__, message->Response());
            }
        },
    ...
    public:
        ...
        void Callback(Exchange::IStream::ICallback* _parameter_896fa94c) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(4));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_896fa94c));
