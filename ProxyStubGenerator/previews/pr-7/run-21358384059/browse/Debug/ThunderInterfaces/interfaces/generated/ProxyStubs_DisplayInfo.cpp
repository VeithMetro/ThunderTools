...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeConnectionPropertiesStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_fe6b3aa7InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_fe6b3aa7{};
            ProxyStub::UnknownProxy* _parameter_fe6b3aa7Proxy__ = nullptr;
            if (_parameter_fe6b3aa7InstanceId__ != 0) {
                _parameter_fe6b3aa7Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_fe6b3aa7InstanceId__, false, _parameter_fe6b3aa7);
                ASSERT((_parameter_fe6b3aa7 != nullptr) && (_parameter_fe6b3aa7Proxy__ != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_fe6b3aa7);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_fe6b3aa7Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_fe6b3aa7Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_dd14104eInstanceId__ = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_dd14104e{};
            ProxyStub::UnknownProxy* _parameter_dd14104eProxy__ = nullptr;
            if (_parameter_dd14104eInstanceId__ != 0) {
                _parameter_dd14104eProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_dd14104eInstanceId__, false, _parameter_dd14104e);
                ASSERT((_parameter_dd14104e != nullptr) && (_parameter_dd14104eProxy__ != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_dd14104e);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_dd14104eProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_dd14104eProxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Register(Exchange::IConnectionProperties::INotification* _parameter_fe6b3aa7) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_fe6b3aa7));
        ...
        uint32_t Unregister(Exchange::IConnectionProperties::INotification* _parameter_dd14104e) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_dd14104e));
