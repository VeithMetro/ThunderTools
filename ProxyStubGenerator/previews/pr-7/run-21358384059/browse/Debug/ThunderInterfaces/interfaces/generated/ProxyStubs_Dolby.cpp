...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeDolbyOutputStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_9e8341afInstanceId__ = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_9e8341af{};
            ProxyStub::UnknownProxy* _parameter_9e8341afProxy__ = nullptr;
            if (_parameter_9e8341afInstanceId__ != 0) {
                _parameter_9e8341afProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_9e8341afInstanceId__, false, _parameter_9e8341af);
                ASSERT((_parameter_9e8341af != nullptr) && (_parameter_9e8341afProxy__ != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_9e8341af);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_9e8341afProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_9e8341afProxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_ab28deadInstanceId__ = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_ab28dead{};
            ProxyStub::UnknownProxy* _parameter_ab28deadProxy__ = nullptr;
            if (_parameter_ab28deadInstanceId__ != 0) {
                _parameter_ab28deadProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_ab28deadInstanceId__, false, _parameter_ab28dead);
                ASSERT((_parameter_ab28dead != nullptr) && (_parameter_ab28deadProxy__ != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_ab28dead);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_ab28deadProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_ab28deadProxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Register(Exchange::Dolby::IOutput::INotification* _parameter_9e8341af) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_9e8341af));
        ...
        uint32_t Unregister(Exchange::Dolby::IOutput::INotification* _parameter_ab28dead) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_ab28dead));
