...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeWebPAStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_3c351d1aInstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_3c351d1a{};
            ProxyStub::UnknownProxy* _parameter_3c351d1aProxy__ = nullptr;
            if (_parameter_3c351d1aInstanceId__ != 0) {
                _parameter_3c351d1aProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_3c351d1aInstanceId__, false, _parameter_3c351d1a);
                ASSERT((_parameter_3c351d1a != nullptr) && (_parameter_3c351d1aProxy__ != nullptr));
            }

            uint32_t result = implementation->Initialize(_parameter_3c351d1a);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_3c351d1aProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_3c351d1aProxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_b1aa3645InstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_b1aa3645{};
            ProxyStub::UnknownProxy* _parameter_b1aa3645Proxy__ = nullptr;
            if (_parameter_b1aa3645InstanceId__ != 0) {
                _parameter_b1aa3645Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_b1aa3645InstanceId__, false, _parameter_b1aa3645);
                ASSERT((_parameter_b1aa3645 != nullptr) && (_parameter_b1aa3645Proxy__ != nullptr));
            }

            implementation->Deinitialize(_parameter_b1aa3645);

            if (_parameter_b1aa3645Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_b1aa3645Proxy__, message->Response());
            }
        },
    ...
    static ProxyStub::MethodHandler ExchangeWebPAWebPAClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_13ebbe25InstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_13ebbe25{};
            ProxyStub::UnknownProxy* _parameter_13ebbe25Proxy__ = nullptr;
            if (_parameter_13ebbe25InstanceId__ != 0) {
                _parameter_13ebbe25Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_13ebbe25InstanceId__, false, _parameter_13ebbe25);
                ASSERT((_parameter_13ebbe25 != nullptr) && (_parameter_13ebbe25Proxy__ != nullptr));
            }

            uint32_t result = implementation->Configure(_parameter_13ebbe25);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_13ebbe25Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_13ebbe25Proxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Initialize(PluginHost::IShell* _parameter_3c351d1a) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_3c351d1a));
        ...
        void Deinitialize(PluginHost::IShell* _parameter_b1aa3645) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_b1aa3645));
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_13ebbe25) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_13ebbe25));
