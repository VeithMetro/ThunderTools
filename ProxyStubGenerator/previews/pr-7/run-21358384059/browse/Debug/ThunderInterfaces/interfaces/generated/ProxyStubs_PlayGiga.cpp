...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangePlayGigaStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            const string _parameter_84892ad2 = reader.Text();
            const string _parameter_87d14818 = reader.Text();

            implementation->Launch(static_cast<const string&>(_parameter_84892ad2), static_cast<const string&>(_parameter_87d14818));
        }
        , nullptr
    ...
    public:
        ...
        void Launch(const string& _parameter_84892ad2, const string& _parameter_87d14818) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_84892ad2);
            writer.Text(_parameter_87d14818);
