...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler RemoteConnectionNotificationStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_31712903InstanceId__ = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_31712903{};
            ProxyStub::UnknownProxy* _parameter_31712903Proxy__ = nullptr;
            if (_parameter_31712903InstanceId__ != 0) {
                _parameter_31712903Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_31712903InstanceId__, false, _parameter_31712903);
                ASSERT((_parameter_31712903 != nullptr) && (_parameter_31712903Proxy__ != nullptr));
            }

            implementation->Activated(_parameter_31712903);

            if (_parameter_31712903Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_31712903Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_9cae69c9InstanceId__ = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_9cae69c9{};
            ProxyStub::UnknownProxy* _parameter_9cae69c9Proxy__ = nullptr;
            if (_parameter_9cae69c9InstanceId__ != 0) {
                _parameter_9cae69c9Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_9cae69c9InstanceId__, false, _parameter_9cae69c9);
                ASSERT((_parameter_9cae69c9 != nullptr) && (_parameter_9cae69c9Proxy__ != nullptr));
            }

            implementation->Deactivated(_parameter_9cae69c9);

            if (_parameter_9cae69c9Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_9cae69c9Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_5a9f82f1InstanceId__ = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_5a9f82f1{};
            ProxyStub::UnknownProxy* _parameter_5a9f82f1Proxy__ = nullptr;
            if (_parameter_5a9f82f1InstanceId__ != 0) {
                _parameter_5a9f82f1Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_5a9f82f1InstanceId__, false, _parameter_5a9f82f1);
                ASSERT((_parameter_5a9f82f1 != nullptr) && (_parameter_5a9f82f1Proxy__ != nullptr));
            }

            implementation->Terminated(_parameter_5a9f82f1);

            if (_parameter_5a9f82f1Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_5a9f82f1Proxy__, message->Response());
            }
        }
        , nullptr
    ...
    public:
        ...
        void Activated(IRemoteConnection* _parameter_31712903) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_31712903));
        ...
        void Deactivated(IRemoteConnection* _parameter_9cae69c9) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_9cae69c9));
        ...
        void Terminated(IRemoteConnection* _parameter_5a9f82f1) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(2));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_5a9f82f1));
