...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler RemoteConnectionNotificationStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_6763f976InstanceId__ = reader.Number<Core::instance_id>();

                IRemoteConnection* _parameter_6763f976{};
                ProxyStub::UnknownProxy* _parameter_6763f976Proxy__ = nullptr;
                if (_parameter_6763f976InstanceId__ != 0) {
                    _parameter_6763f976Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_6763f976InstanceId__, false, _parameter_6763f976);
                    ASSERT((_parameter_6763f976 != nullptr) && (_parameter_6763f976Proxy__ != nullptr));
                    if ((_parameter_6763f976 == nullptr) || (_parameter_6763f976Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Activated(_parameter_6763f976);

                if (_parameter_6763f976Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_6763f976Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_7f266fb8InstanceId__ = reader.Number<Core::instance_id>();

                IRemoteConnection* _parameter_7f266fb8{};
                ProxyStub::UnknownProxy* _parameter_7f266fb8Proxy__ = nullptr;
                if (_parameter_7f266fb8InstanceId__ != 0) {
                    _parameter_7f266fb8Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_7f266fb8InstanceId__, false, _parameter_7f266fb8);
                    ASSERT((_parameter_7f266fb8 != nullptr) && (_parameter_7f266fb8Proxy__ != nullptr));
                    if ((_parameter_7f266fb8 == nullptr) || (_parameter_7f266fb8Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Deactivated(_parameter_7f266fb8);

                if (_parameter_7f266fb8Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_7f266fb8Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_146c5f79InstanceId__ = reader.Number<Core::instance_id>();

                IRemoteConnection* _parameter_146c5f79{};
                ProxyStub::UnknownProxy* _parameter_146c5f79Proxy__ = nullptr;
                if (_parameter_146c5f79InstanceId__ != 0) {
                    _parameter_146c5f79Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_146c5f79InstanceId__, false, _parameter_146c5f79);
                    ASSERT((_parameter_146c5f79 != nullptr) && (_parameter_146c5f79Proxy__ != nullptr));
                    if ((_parameter_146c5f79 == nullptr) || (_parameter_146c5f79Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Terminated(_parameter_146c5f79);

                if (_parameter_146c5f79Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_146c5f79Proxy__, message->Response());
                }
    ...
    public:
        ...
        void Activated(IRemoteConnection* _parameter_6763f976) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_6763f976));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_6763f976), IRemoteConnection::ID }, { 0, 0 } };
        ...
        void Deactivated(IRemoteConnection* _parameter_7f266fb8) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_7f266fb8));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_7f266fb8), IRemoteConnection::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
        ...
        void Terminated(IRemoteConnection* _parameter_146c5f79) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(2));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_146c5f79));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_146c5f79), IRemoteConnection::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
