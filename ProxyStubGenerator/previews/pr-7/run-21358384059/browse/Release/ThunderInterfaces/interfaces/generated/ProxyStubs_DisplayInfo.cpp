...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeConnectionPropertiesStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_bdb77620InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IConnectionProperties::INotification* _parameter_bdb77620{};
                ProxyStub::UnknownProxy* _parameter_bdb77620Proxy__ = nullptr;
                if (_parameter_bdb77620InstanceId__ != 0) {
                    _parameter_bdb77620Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_bdb77620InstanceId__, false, _parameter_bdb77620);
                    ASSERT((_parameter_bdb77620 != nullptr) && (_parameter_bdb77620Proxy__ != nullptr));
                    if ((_parameter_bdb77620 == nullptr) || (_parameter_bdb77620Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Register(_parameter_bdb77620);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_bdb77620Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_bdb77620Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_7d074e4aInstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IConnectionProperties::INotification* _parameter_7d074e4a{};
                ProxyStub::UnknownProxy* _parameter_7d074e4aProxy__ = nullptr;
                if (_parameter_7d074e4aInstanceId__ != 0) {
                    _parameter_7d074e4aProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_7d074e4aInstanceId__, false, _parameter_7d074e4a);
                    ASSERT((_parameter_7d074e4a != nullptr) && (_parameter_7d074e4aProxy__ != nullptr));
                    if ((_parameter_7d074e4a == nullptr) || (_parameter_7d074e4aProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Unregister(_parameter_7d074e4a);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_7d074e4aProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_7d074e4aProxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Register(Exchange::IConnectionProperties::INotification* _parameter_bdb77620) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_bdb77620));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_bdb77620), Exchange::IConnectionProperties::INotification::ID }, { 0, 0 } };
        ...
        uint32_t Unregister(Exchange::IConnectionProperties::INotification* _parameter_7d074e4a) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_7d074e4a));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_7d074e4a), Exchange::IConnectionProperties::INotification::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
