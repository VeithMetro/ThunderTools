...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeDolbyOutputStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_47234f38InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::Dolby::IOutput::INotification* _parameter_47234f38{};
                ProxyStub::UnknownProxy* _parameter_47234f38Proxy__ = nullptr;
                if (_parameter_47234f38InstanceId__ != 0) {
                    _parameter_47234f38Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_47234f38InstanceId__, false, _parameter_47234f38);
                    ASSERT((_parameter_47234f38 != nullptr) && (_parameter_47234f38Proxy__ != nullptr));
                    if ((_parameter_47234f38 == nullptr) || (_parameter_47234f38Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Register(_parameter_47234f38);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_47234f38Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_47234f38Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_5b71256fInstanceId__ = reader.Number<Core::instance_id>();

                Exchange::Dolby::IOutput::INotification* _parameter_5b71256f{};
                ProxyStub::UnknownProxy* _parameter_5b71256fProxy__ = nullptr;
                if (_parameter_5b71256fInstanceId__ != 0) {
                    _parameter_5b71256fProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_5b71256fInstanceId__, false, _parameter_5b71256f);
                    ASSERT((_parameter_5b71256f != nullptr) && (_parameter_5b71256fProxy__ != nullptr));
                    if ((_parameter_5b71256f == nullptr) || (_parameter_5b71256fProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Unregister(_parameter_5b71256f);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_5b71256fProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_5b71256fProxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Register(Exchange::Dolby::IOutput::INotification* _parameter_47234f38) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_47234f38));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_47234f38), Exchange::Dolby::IOutput::INotification::ID }, { 0, 0 } };
        ...
        uint32_t Unregister(Exchange::Dolby::IOutput::INotification* _parameter_5b71256f) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_5b71256f));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_5b71256f), Exchange::Dolby::IOutput::INotification::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
