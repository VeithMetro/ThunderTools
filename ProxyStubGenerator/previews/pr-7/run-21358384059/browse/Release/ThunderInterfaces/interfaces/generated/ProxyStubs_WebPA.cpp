...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeWebPAStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_b1061540InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_b1061540{};
                ProxyStub::UnknownProxy* _parameter_b1061540Proxy__ = nullptr;
                if (_parameter_b1061540InstanceId__ != 0) {
                    _parameter_b1061540Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_b1061540InstanceId__, false, _parameter_b1061540);
                    ASSERT((_parameter_b1061540 != nullptr) && (_parameter_b1061540Proxy__ != nullptr));
                    if ((_parameter_b1061540 == nullptr) || (_parameter_b1061540Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Initialize(_parameter_b1061540);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_b1061540Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_b1061540Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_ea783187InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_ea783187{};
                ProxyStub::UnknownProxy* _parameter_ea783187Proxy__ = nullptr;
                if (_parameter_ea783187InstanceId__ != 0) {
                    _parameter_ea783187Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_ea783187InstanceId__, false, _parameter_ea783187);
                    ASSERT((_parameter_ea783187 != nullptr) && (_parameter_ea783187Proxy__ != nullptr));
                    if ((_parameter_ea783187 == nullptr) || (_parameter_ea783187Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Deinitialize(_parameter_ea783187);

                if (_parameter_ea783187Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_ea783187Proxy__, message->Response());
                }
    ...
    static ProxyStub::MethodHandler ExchangeWebPAWebPAClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_91123895InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_91123895{};
                ProxyStub::UnknownProxy* _parameter_91123895Proxy__ = nullptr;
                if (_parameter_91123895InstanceId__ != 0) {
                    _parameter_91123895Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_91123895InstanceId__, false, _parameter_91123895);
                    ASSERT((_parameter_91123895 != nullptr) && (_parameter_91123895Proxy__ != nullptr));
                    if ((_parameter_91123895 == nullptr) || (_parameter_91123895Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Configure(_parameter_91123895);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_91123895Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_91123895Proxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Initialize(PluginHost::IShell* _parameter_b1061540) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_b1061540));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_b1061540), PluginHost::IShell::ID }, { 0, 0 } };
        ...
        void Deinitialize(PluginHost::IShell* _parameter_ea783187) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_ea783187));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_ea783187), PluginHost::IShell::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_91123895) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_91123895));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_91123895), PluginHost::IShell::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
