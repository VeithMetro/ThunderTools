...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler RemoteConnectionNotificationStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_96ec6e39InstanceId__ = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_96ec6e39{};
            ProxyStub::UnknownProxy* _parameter_96ec6e39Proxy__ = nullptr;
            if (_parameter_96ec6e39InstanceId__ != 0) {
                _parameter_96ec6e39Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_96ec6e39InstanceId__, false, _parameter_96ec6e39);
                ASSERT((_parameter_96ec6e39 != nullptr) && (_parameter_96ec6e39Proxy__ != nullptr));
            }

            implementation->Activated(_parameter_96ec6e39);

            if (_parameter_96ec6e39Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_96ec6e39Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_85364809InstanceId__ = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_85364809{};
            ProxyStub::UnknownProxy* _parameter_85364809Proxy__ = nullptr;
            if (_parameter_85364809InstanceId__ != 0) {
                _parameter_85364809Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_85364809InstanceId__, false, _parameter_85364809);
                ASSERT((_parameter_85364809 != nullptr) && (_parameter_85364809Proxy__ != nullptr));
            }

            implementation->Deactivated(_parameter_85364809);

            if (_parameter_85364809Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_85364809Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_a04f7cfbInstanceId__ = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_a04f7cfb{};
            ProxyStub::UnknownProxy* _parameter_a04f7cfbProxy__ = nullptr;
            if (_parameter_a04f7cfbInstanceId__ != 0) {
                _parameter_a04f7cfbProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_a04f7cfbInstanceId__, false, _parameter_a04f7cfb);
                ASSERT((_parameter_a04f7cfb != nullptr) && (_parameter_a04f7cfbProxy__ != nullptr));
            }

            implementation->Terminated(_parameter_a04f7cfb);

            if (_parameter_a04f7cfbProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_a04f7cfbProxy__, message->Response());
            }
        }
        , nullptr
    ...
    public:
        ...
        void Activated(IRemoteConnection* _parameter_96ec6e39) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_96ec6e39));
        ...
        void Deactivated(IRemoteConnection* _parameter_85364809) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_85364809));
        ...
        void Terminated(IRemoteConnection* _parameter_a04f7cfb) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(2));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_a04f7cfb));
