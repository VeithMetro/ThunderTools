...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeDolbyOutputStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_e8cbf703InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_e8cbf703{};
            ProxyStub::UnknownProxy* _parameter_e8cbf703Proxy__ = nullptr;
            if (_parameter_e8cbf703InstanceId__ != 0) {
                _parameter_e8cbf703Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_e8cbf703InstanceId__, false, _parameter_e8cbf703);
                ASSERT((_parameter_e8cbf703 != nullptr) && (_parameter_e8cbf703Proxy__ != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_e8cbf703);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_e8cbf703Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_e8cbf703Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_31ddcb56InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_31ddcb56{};
            ProxyStub::UnknownProxy* _parameter_31ddcb56Proxy__ = nullptr;
            if (_parameter_31ddcb56InstanceId__ != 0) {
                _parameter_31ddcb56Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_31ddcb56InstanceId__, false, _parameter_31ddcb56);
                ASSERT((_parameter_31ddcb56 != nullptr) && (_parameter_31ddcb56Proxy__ != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_31ddcb56);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_31ddcb56Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_31ddcb56Proxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Register(Exchange::Dolby::IOutput::INotification* _parameter_e8cbf703) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_e8cbf703));
        ...
        uint32_t Unregister(Exchange::Dolby::IOutput::INotification* _parameter_31ddcb56) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_31ddcb56));
