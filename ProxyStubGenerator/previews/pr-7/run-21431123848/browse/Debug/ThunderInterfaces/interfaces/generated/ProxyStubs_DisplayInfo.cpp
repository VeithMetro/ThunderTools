...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeConnectionPropertiesStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_a95c66a4InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_a95c66a4{};
            ProxyStub::UnknownProxy* _parameter_a95c66a4Proxy__ = nullptr;
            if (_parameter_a95c66a4InstanceId__ != 0) {
                _parameter_a95c66a4Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_a95c66a4InstanceId__, false, _parameter_a95c66a4);
                ASSERT((_parameter_a95c66a4 != nullptr) && (_parameter_a95c66a4Proxy__ != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_a95c66a4);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_a95c66a4Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_a95c66a4Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_4d74c1cbInstanceId__ = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_4d74c1cb{};
            ProxyStub::UnknownProxy* _parameter_4d74c1cbProxy__ = nullptr;
            if (_parameter_4d74c1cbInstanceId__ != 0) {
                _parameter_4d74c1cbProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_4d74c1cbInstanceId__, false, _parameter_4d74c1cb);
                ASSERT((_parameter_4d74c1cb != nullptr) && (_parameter_4d74c1cbProxy__ != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_4d74c1cb);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_4d74c1cbProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_4d74c1cbProxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Register(Exchange::IConnectionProperties::INotification* _parameter_a95c66a4) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_a95c66a4));
        ...
        uint32_t Unregister(Exchange::IConnectionProperties::INotification* _parameter_4d74c1cb) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_4d74c1cb));
