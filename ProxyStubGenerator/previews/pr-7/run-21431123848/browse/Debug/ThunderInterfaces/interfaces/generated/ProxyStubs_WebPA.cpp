...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeWebPAStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_6686b715InstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_6686b715{};
            ProxyStub::UnknownProxy* _parameter_6686b715Proxy__ = nullptr;
            if (_parameter_6686b715InstanceId__ != 0) {
                _parameter_6686b715Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_6686b715InstanceId__, false, _parameter_6686b715);
                ASSERT((_parameter_6686b715 != nullptr) && (_parameter_6686b715Proxy__ != nullptr));
            }

            uint32_t result = implementation->Initialize(_parameter_6686b715);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_6686b715Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_6686b715Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_cd86e01dInstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_cd86e01d{};
            ProxyStub::UnknownProxy* _parameter_cd86e01dProxy__ = nullptr;
            if (_parameter_cd86e01dInstanceId__ != 0) {
                _parameter_cd86e01dProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_cd86e01dInstanceId__, false, _parameter_cd86e01d);
                ASSERT((_parameter_cd86e01d != nullptr) && (_parameter_cd86e01dProxy__ != nullptr));
            }

            implementation->Deinitialize(_parameter_cd86e01d);

            if (_parameter_cd86e01dProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_cd86e01dProxy__, message->Response());
            }
        },
    ...
    static ProxyStub::MethodHandler ExchangeWebPAWebPAClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_de815b60InstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_de815b60{};
            ProxyStub::UnknownProxy* _parameter_de815b60Proxy__ = nullptr;
            if (_parameter_de815b60InstanceId__ != 0) {
                _parameter_de815b60Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_de815b60InstanceId__, false, _parameter_de815b60);
                ASSERT((_parameter_de815b60 != nullptr) && (_parameter_de815b60Proxy__ != nullptr));
            }

            uint32_t result = implementation->Configure(_parameter_de815b60);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_de815b60Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_de815b60Proxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Initialize(PluginHost::IShell* _parameter_6686b715) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_6686b715));
        ...
        void Deinitialize(PluginHost::IShell* _parameter_cd86e01d) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_cd86e01d));
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_de815b60) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_de815b60));
