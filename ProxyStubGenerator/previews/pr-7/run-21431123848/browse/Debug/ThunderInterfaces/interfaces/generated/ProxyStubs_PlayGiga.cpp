...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangePlayGigaStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            const string _parameter_900d042b = reader.Text();
            const string _parameter_fea0f296 = reader.Text();

            implementation->Launch(static_cast<const string&>(_parameter_900d042b), static_cast<const string&>(_parameter_fea0f296));
        }
        , nullptr
    ...
    public:
        ...
        void Launch(const string& _parameter_900d042b, const string& _parameter_fea0f296) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_900d042b);
            writer.Text(_parameter_fea0f296);
