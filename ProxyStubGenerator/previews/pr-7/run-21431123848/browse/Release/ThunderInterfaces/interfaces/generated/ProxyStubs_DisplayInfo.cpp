...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeConnectionPropertiesStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_c1a4886cInstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IConnectionProperties::INotification* _parameter_c1a4886c{};
                ProxyStub::UnknownProxy* _parameter_c1a4886cProxy__ = nullptr;
                if (_parameter_c1a4886cInstanceId__ != 0) {
                    _parameter_c1a4886cProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_c1a4886cInstanceId__, false, _parameter_c1a4886c);
                    ASSERT((_parameter_c1a4886c != nullptr) && (_parameter_c1a4886cProxy__ != nullptr));
                    if ((_parameter_c1a4886c == nullptr) || (_parameter_c1a4886cProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Register(_parameter_c1a4886c);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_c1a4886cProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_c1a4886cProxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_435156d6InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IConnectionProperties::INotification* _parameter_435156d6{};
                ProxyStub::UnknownProxy* _parameter_435156d6Proxy__ = nullptr;
                if (_parameter_435156d6InstanceId__ != 0) {
                    _parameter_435156d6Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_435156d6InstanceId__, false, _parameter_435156d6);
                    ASSERT((_parameter_435156d6 != nullptr) && (_parameter_435156d6Proxy__ != nullptr));
                    if ((_parameter_435156d6 == nullptr) || (_parameter_435156d6Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Unregister(_parameter_435156d6);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_435156d6Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_435156d6Proxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Register(Exchange::IConnectionProperties::INotification* _parameter_c1a4886c) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_c1a4886c));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_c1a4886c), Exchange::IConnectionProperties::INotification::ID }, { 0, 0 } };
        ...
        uint32_t Unregister(Exchange::IConnectionProperties::INotification* _parameter_435156d6) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_435156d6));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_435156d6), Exchange::IConnectionProperties::INotification::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
