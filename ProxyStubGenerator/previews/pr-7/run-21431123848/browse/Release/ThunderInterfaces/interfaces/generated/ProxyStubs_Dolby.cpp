...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeDolbyOutputStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_e4626beaInstanceId__ = reader.Number<Core::instance_id>();

                Exchange::Dolby::IOutput::INotification* _parameter_e4626bea{};
                ProxyStub::UnknownProxy* _parameter_e4626beaProxy__ = nullptr;
                if (_parameter_e4626beaInstanceId__ != 0) {
                    _parameter_e4626beaProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_e4626beaInstanceId__, false, _parameter_e4626bea);
                    ASSERT((_parameter_e4626bea != nullptr) && (_parameter_e4626beaProxy__ != nullptr));
                    if ((_parameter_e4626bea == nullptr) || (_parameter_e4626beaProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Register(_parameter_e4626bea);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_e4626beaProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_e4626beaProxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_15032308InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::Dolby::IOutput::INotification* _parameter_15032308{};
                ProxyStub::UnknownProxy* _parameter_15032308Proxy__ = nullptr;
                if (_parameter_15032308InstanceId__ != 0) {
                    _parameter_15032308Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_15032308InstanceId__, false, _parameter_15032308);
                    ASSERT((_parameter_15032308 != nullptr) && (_parameter_15032308Proxy__ != nullptr));
                    if ((_parameter_15032308 == nullptr) || (_parameter_15032308Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Unregister(_parameter_15032308);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_15032308Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_15032308Proxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Register(Exchange::Dolby::IOutput::INotification* _parameter_e4626bea) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_e4626bea));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_e4626bea), Exchange::Dolby::IOutput::INotification::ID }, { 0, 0 } };
        ...
        uint32_t Unregister(Exchange::Dolby::IOutput::INotification* _parameter_15032308) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_15032308));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_15032308), Exchange::Dolby::IOutput::INotification::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
