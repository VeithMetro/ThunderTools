...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeWebPAStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_3fafd074InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_3fafd074{};
                ProxyStub::UnknownProxy* _parameter_3fafd074Proxy__ = nullptr;
                if (_parameter_3fafd074InstanceId__ != 0) {
                    _parameter_3fafd074Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_3fafd074InstanceId__, false, _parameter_3fafd074);
                    ASSERT((_parameter_3fafd074 != nullptr) && (_parameter_3fafd074Proxy__ != nullptr));
                    if ((_parameter_3fafd074 == nullptr) || (_parameter_3fafd074Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Initialize(_parameter_3fafd074);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_3fafd074Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_3fafd074Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_e10a6fc2InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_e10a6fc2{};
                ProxyStub::UnknownProxy* _parameter_e10a6fc2Proxy__ = nullptr;
                if (_parameter_e10a6fc2InstanceId__ != 0) {
                    _parameter_e10a6fc2Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_e10a6fc2InstanceId__, false, _parameter_e10a6fc2);
                    ASSERT((_parameter_e10a6fc2 != nullptr) && (_parameter_e10a6fc2Proxy__ != nullptr));
                    if ((_parameter_e10a6fc2 == nullptr) || (_parameter_e10a6fc2Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Deinitialize(_parameter_e10a6fc2);

                if (_parameter_e10a6fc2Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_e10a6fc2Proxy__, message->Response());
                }
    ...
    static ProxyStub::MethodHandler ExchangeWebPAWebPAClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_fb5adbf3InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_fb5adbf3{};
                ProxyStub::UnknownProxy* _parameter_fb5adbf3Proxy__ = nullptr;
                if (_parameter_fb5adbf3InstanceId__ != 0) {
                    _parameter_fb5adbf3Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_fb5adbf3InstanceId__, false, _parameter_fb5adbf3);
                    ASSERT((_parameter_fb5adbf3 != nullptr) && (_parameter_fb5adbf3Proxy__ != nullptr));
                    if ((_parameter_fb5adbf3 == nullptr) || (_parameter_fb5adbf3Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Configure(_parameter_fb5adbf3);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_fb5adbf3Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_fb5adbf3Proxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Initialize(PluginHost::IShell* _parameter_3fafd074) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_3fafd074));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_3fafd074), PluginHost::IShell::ID }, { 0, 0 } };
        ...
        void Deinitialize(PluginHost::IShell* _parameter_e10a6fc2) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_e10a6fc2));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_e10a6fc2), PluginHost::IShell::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_fb5adbf3) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_fb5adbf3));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_fb5adbf3), PluginHost::IShell::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
