...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler RemoteConnectionNotificationStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_91da2ae2InstanceId__ = reader.Number<Core::instance_id>();

                IRemoteConnection* _parameter_91da2ae2{};
                ProxyStub::UnknownProxy* _parameter_91da2ae2Proxy__ = nullptr;
                if (_parameter_91da2ae2InstanceId__ != 0) {
                    _parameter_91da2ae2Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_91da2ae2InstanceId__, false, _parameter_91da2ae2);
                    ASSERT((_parameter_91da2ae2 != nullptr) && (_parameter_91da2ae2Proxy__ != nullptr));
                    if ((_parameter_91da2ae2 == nullptr) || (_parameter_91da2ae2Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Activated(_parameter_91da2ae2);

                if (_parameter_91da2ae2Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_91da2ae2Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_1290654dInstanceId__ = reader.Number<Core::instance_id>();

                IRemoteConnection* _parameter_1290654d{};
                ProxyStub::UnknownProxy* _parameter_1290654dProxy__ = nullptr;
                if (_parameter_1290654dInstanceId__ != 0) {
                    _parameter_1290654dProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_1290654dInstanceId__, false, _parameter_1290654d);
                    ASSERT((_parameter_1290654d != nullptr) && (_parameter_1290654dProxy__ != nullptr));
                    if ((_parameter_1290654d == nullptr) || (_parameter_1290654dProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Deactivated(_parameter_1290654d);

                if (_parameter_1290654dProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_1290654dProxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_56cd63d5InstanceId__ = reader.Number<Core::instance_id>();

                IRemoteConnection* _parameter_56cd63d5{};
                ProxyStub::UnknownProxy* _parameter_56cd63d5Proxy__ = nullptr;
                if (_parameter_56cd63d5InstanceId__ != 0) {
                    _parameter_56cd63d5Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_56cd63d5InstanceId__, false, _parameter_56cd63d5);
                    ASSERT((_parameter_56cd63d5 != nullptr) && (_parameter_56cd63d5Proxy__ != nullptr));
                    if ((_parameter_56cd63d5 == nullptr) || (_parameter_56cd63d5Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Terminated(_parameter_56cd63d5);

                if (_parameter_56cd63d5Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_56cd63d5Proxy__, message->Response());
                }
    ...
    public:
        ...
        void Activated(IRemoteConnection* _parameter_91da2ae2) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_91da2ae2));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_91da2ae2), IRemoteConnection::ID }, { 0, 0 } };
        ...
        void Deactivated(IRemoteConnection* _parameter_1290654d) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_1290654d));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_1290654d), IRemoteConnection::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
        ...
        void Terminated(IRemoteConnection* _parameter_56cd63d5) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(2));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_56cd63d5));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_56cd63d5), IRemoteConnection::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
