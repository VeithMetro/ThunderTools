...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeDolbyOutputStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_cecd5a37InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::Dolby::IOutput::INotification* _parameter_cecd5a37{};
                ProxyStub::UnknownProxy* _parameter_cecd5a37Proxy__ = nullptr;
                if (_parameter_cecd5a37InstanceId__ != 0) {
                    _parameter_cecd5a37Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_cecd5a37InstanceId__, false, _parameter_cecd5a37);
                    ASSERT((_parameter_cecd5a37 != nullptr) && (_parameter_cecd5a37Proxy__ != nullptr));
                    if ((_parameter_cecd5a37 == nullptr) || (_parameter_cecd5a37Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Register(_parameter_cecd5a37);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_cecd5a37Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_cecd5a37Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_a6193e05InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::Dolby::IOutput::INotification* _parameter_a6193e05{};
                ProxyStub::UnknownProxy* _parameter_a6193e05Proxy__ = nullptr;
                if (_parameter_a6193e05InstanceId__ != 0) {
                    _parameter_a6193e05Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_a6193e05InstanceId__, false, _parameter_a6193e05);
                    ASSERT((_parameter_a6193e05 != nullptr) && (_parameter_a6193e05Proxy__ != nullptr));
                    if ((_parameter_a6193e05 == nullptr) || (_parameter_a6193e05Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Unregister(_parameter_a6193e05);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_a6193e05Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_a6193e05Proxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Register(Exchange::Dolby::IOutput::INotification* _parameter_cecd5a37) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_cecd5a37));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_cecd5a37), Exchange::Dolby::IOutput::INotification::ID }, { 0, 0 } };
        ...
        uint32_t Unregister(Exchange::Dolby::IOutput::INotification* _parameter_a6193e05) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_a6193e05));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_a6193e05), Exchange::Dolby::IOutput::INotification::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
