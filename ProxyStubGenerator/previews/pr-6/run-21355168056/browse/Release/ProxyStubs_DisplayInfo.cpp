...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeConnectionPropertiesStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_ca349a13InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IConnectionProperties::INotification* _parameter_ca349a13{};
                ProxyStub::UnknownProxy* _parameter_ca349a13Proxy__ = nullptr;
                if (_parameter_ca349a13InstanceId__ != 0) {
                    _parameter_ca349a13Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_ca349a13InstanceId__, false, _parameter_ca349a13);
                    ASSERT((_parameter_ca349a13 != nullptr) && (_parameter_ca349a13Proxy__ != nullptr));
                    if ((_parameter_ca349a13 == nullptr) || (_parameter_ca349a13Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Register(_parameter_ca349a13);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_ca349a13Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_ca349a13Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_41c86f8fInstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IConnectionProperties::INotification* _parameter_41c86f8f{};
                ProxyStub::UnknownProxy* _parameter_41c86f8fProxy__ = nullptr;
                if (_parameter_41c86f8fInstanceId__ != 0) {
                    _parameter_41c86f8fProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_41c86f8fInstanceId__, false, _parameter_41c86f8f);
                    ASSERT((_parameter_41c86f8f != nullptr) && (_parameter_41c86f8fProxy__ != nullptr));
                    if ((_parameter_41c86f8f == nullptr) || (_parameter_41c86f8fProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Unregister(_parameter_41c86f8f);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_41c86f8fProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_41c86f8fProxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Register(Exchange::IConnectionProperties::INotification* _parameter_ca349a13) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_ca349a13));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_ca349a13), Exchange::IConnectionProperties::INotification::ID }, { 0, 0 } };
        ...
        uint32_t Unregister(Exchange::IConnectionProperties::INotification* _parameter_41c86f8f) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_41c86f8f));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_41c86f8f), Exchange::IConnectionProperties::INotification::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
