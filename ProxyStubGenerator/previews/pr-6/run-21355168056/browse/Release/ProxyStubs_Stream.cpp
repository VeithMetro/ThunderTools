...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeStreamStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_71ccdf4fInstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IStream::ICallback* _parameter_71ccdf4f{};
                ProxyStub::UnknownProxy* _parameter_71ccdf4fProxy__ = nullptr;
                if (_parameter_71ccdf4fInstanceId__ != 0) {
                    _parameter_71ccdf4fProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_71ccdf4fInstanceId__, false, _parameter_71ccdf4f);
                    ASSERT((_parameter_71ccdf4f != nullptr) && (_parameter_71ccdf4fProxy__ != nullptr));
                    if ((_parameter_71ccdf4f == nullptr) || (_parameter_71ccdf4fProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Callback(_parameter_71ccdf4f);

                if (_parameter_71ccdf4fProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_71ccdf4fProxy__, message->Response());
                }
    ...
    public:
        ...
        void Callback(Exchange::IStream::ICallback* _parameter_71ccdf4f) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(4));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_71ccdf4f));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_71ccdf4f), Exchange::IStream::ICallback::ID }, { 0, 0 } };
