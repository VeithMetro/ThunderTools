...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeWebPAStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_b24e75b7InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_b24e75b7{};
                ProxyStub::UnknownProxy* _parameter_b24e75b7Proxy__ = nullptr;
                if (_parameter_b24e75b7InstanceId__ != 0) {
                    _parameter_b24e75b7Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_b24e75b7InstanceId__, false, _parameter_b24e75b7);
                    ASSERT((_parameter_b24e75b7 != nullptr) && (_parameter_b24e75b7Proxy__ != nullptr));
                    if ((_parameter_b24e75b7 == nullptr) || (_parameter_b24e75b7Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Initialize(_parameter_b24e75b7);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_b24e75b7Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_b24e75b7Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_3f7dc257InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_3f7dc257{};
                ProxyStub::UnknownProxy* _parameter_3f7dc257Proxy__ = nullptr;
                if (_parameter_3f7dc257InstanceId__ != 0) {
                    _parameter_3f7dc257Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_3f7dc257InstanceId__, false, _parameter_3f7dc257);
                    ASSERT((_parameter_3f7dc257 != nullptr) && (_parameter_3f7dc257Proxy__ != nullptr));
                    if ((_parameter_3f7dc257 == nullptr) || (_parameter_3f7dc257Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Deinitialize(_parameter_3f7dc257);

                if (_parameter_3f7dc257Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_3f7dc257Proxy__, message->Response());
                }
    ...
    static ProxyStub::MethodHandler ExchangeWebPAWebPAClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_5ce262d0InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_5ce262d0{};
                ProxyStub::UnknownProxy* _parameter_5ce262d0Proxy__ = nullptr;
                if (_parameter_5ce262d0InstanceId__ != 0) {
                    _parameter_5ce262d0Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_5ce262d0InstanceId__, false, _parameter_5ce262d0);
                    ASSERT((_parameter_5ce262d0 != nullptr) && (_parameter_5ce262d0Proxy__ != nullptr));
                    if ((_parameter_5ce262d0 == nullptr) || (_parameter_5ce262d0Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Configure(_parameter_5ce262d0);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_5ce262d0Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_5ce262d0Proxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Initialize(PluginHost::IShell* _parameter_b24e75b7) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_b24e75b7));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_b24e75b7), PluginHost::IShell::ID }, { 0, 0 } };
        ...
        void Deinitialize(PluginHost::IShell* _parameter_3f7dc257) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_3f7dc257));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_3f7dc257), PluginHost::IShell::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_5ce262d0) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_5ce262d0));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_5ce262d0), PluginHost::IShell::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
