...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeWebPAStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_4bf061abInstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_4bf061ab{};
            ProxyStub::UnknownProxy* _parameter_4bf061abProxy__ = nullptr;
            if (_parameter_4bf061abInstanceId__ != 0) {
                _parameter_4bf061abProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_4bf061abInstanceId__, false, _parameter_4bf061ab);
                ASSERT((_parameter_4bf061ab != nullptr) && (_parameter_4bf061abProxy__ != nullptr));
            }

            uint32_t result = implementation->Initialize(_parameter_4bf061ab);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_4bf061abProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_4bf061abProxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_891ac017InstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_891ac017{};
            ProxyStub::UnknownProxy* _parameter_891ac017Proxy__ = nullptr;
            if (_parameter_891ac017InstanceId__ != 0) {
                _parameter_891ac017Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_891ac017InstanceId__, false, _parameter_891ac017);
                ASSERT((_parameter_891ac017 != nullptr) && (_parameter_891ac017Proxy__ != nullptr));
            }

            implementation->Deinitialize(_parameter_891ac017);

            if (_parameter_891ac017Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_891ac017Proxy__, message->Response());
            }
        },
    ...
    static ProxyStub::MethodHandler ExchangeWebPAWebPAClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_b2216807InstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_b2216807{};
            ProxyStub::UnknownProxy* _parameter_b2216807Proxy__ = nullptr;
            if (_parameter_b2216807InstanceId__ != 0) {
                _parameter_b2216807Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_b2216807InstanceId__, false, _parameter_b2216807);
                ASSERT((_parameter_b2216807 != nullptr) && (_parameter_b2216807Proxy__ != nullptr));
            }

            uint32_t result = implementation->Configure(_parameter_b2216807);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_b2216807Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_b2216807Proxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Initialize(PluginHost::IShell* _parameter_4bf061ab) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_4bf061ab));
        ...
        void Deinitialize(PluginHost::IShell* _parameter_891ac017) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_891ac017));
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_b2216807) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_b2216807));
