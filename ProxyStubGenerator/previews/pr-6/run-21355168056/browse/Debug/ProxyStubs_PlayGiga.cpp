...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangePlayGigaStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            const string _parameter_eee922eb = reader.Text();
            const string _parameter_53a9cde7 = reader.Text();

            implementation->Launch(static_cast<const string&>(_parameter_eee922eb), static_cast<const string&>(_parameter_53a9cde7));
        }
        , nullptr
    ...
    public:
        ...
        void Launch(const string& _parameter_eee922eb, const string& _parameter_53a9cde7) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_eee922eb);
            writer.Text(_parameter_53a9cde7);
