...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeConnectionPropertiesStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_da833038InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_da833038{};
            ProxyStub::UnknownProxy* _parameter_da833038Proxy__ = nullptr;
            if (_parameter_da833038InstanceId__ != 0) {
                _parameter_da833038Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_da833038InstanceId__, false, _parameter_da833038);
                ASSERT((_parameter_da833038 != nullptr) && (_parameter_da833038Proxy__ != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_da833038);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_da833038Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_da833038Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_6e2362b2InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_6e2362b2{};
            ProxyStub::UnknownProxy* _parameter_6e2362b2Proxy__ = nullptr;
            if (_parameter_6e2362b2InstanceId__ != 0) {
                _parameter_6e2362b2Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_6e2362b2InstanceId__, false, _parameter_6e2362b2);
                ASSERT((_parameter_6e2362b2 != nullptr) && (_parameter_6e2362b2Proxy__ != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_6e2362b2);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_6e2362b2Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_6e2362b2Proxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Register(Exchange::IConnectionProperties::INotification* _parameter_da833038) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_da833038));
        ...
        uint32_t Unregister(Exchange::IConnectionProperties::INotification* _parameter_6e2362b2) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_6e2362b2));
