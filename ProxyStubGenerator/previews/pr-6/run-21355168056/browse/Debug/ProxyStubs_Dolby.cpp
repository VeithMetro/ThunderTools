...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeDolbyOutputStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_4f32973eInstanceId__ = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_4f32973e{};
            ProxyStub::UnknownProxy* _parameter_4f32973eProxy__ = nullptr;
            if (_parameter_4f32973eInstanceId__ != 0) {
                _parameter_4f32973eProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_4f32973eInstanceId__, false, _parameter_4f32973e);
                ASSERT((_parameter_4f32973e != nullptr) && (_parameter_4f32973eProxy__ != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_4f32973e);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_4f32973eProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_4f32973eProxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_88d55731InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_88d55731{};
            ProxyStub::UnknownProxy* _parameter_88d55731Proxy__ = nullptr;
            if (_parameter_88d55731InstanceId__ != 0) {
                _parameter_88d55731Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_88d55731InstanceId__, false, _parameter_88d55731);
                ASSERT((_parameter_88d55731 != nullptr) && (_parameter_88d55731Proxy__ != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_88d55731);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_88d55731Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_88d55731Proxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Register(Exchange::Dolby::IOutput::INotification* _parameter_4f32973e) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_4f32973e));
        ...
        uint32_t Unregister(Exchange::Dolby::IOutput::INotification* _parameter_88d55731) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_88d55731));
