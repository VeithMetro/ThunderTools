...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeDolbyOutputStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_5a12100dInstanceId__ = reader.Number<Core::instance_id>();

                Exchange::Dolby::IOutput::INotification* _parameter_5a12100d{};
                ProxyStub::UnknownProxy* _parameter_5a12100dProxy__ = nullptr;
                if (_parameter_5a12100dInstanceId__ != 0) {
                    _parameter_5a12100dProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_5a12100dInstanceId__, false, _parameter_5a12100d);
                    ASSERT((_parameter_5a12100d != nullptr) && (_parameter_5a12100dProxy__ != nullptr));
                    if ((_parameter_5a12100d == nullptr) || (_parameter_5a12100dProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Register(_parameter_5a12100d);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_5a12100dProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_5a12100dProxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_a418da4fInstanceId__ = reader.Number<Core::instance_id>();

                Exchange::Dolby::IOutput::INotification* _parameter_a418da4f{};
                ProxyStub::UnknownProxy* _parameter_a418da4fProxy__ = nullptr;
                if (_parameter_a418da4fInstanceId__ != 0) {
                    _parameter_a418da4fProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_a418da4fInstanceId__, false, _parameter_a418da4f);
                    ASSERT((_parameter_a418da4f != nullptr) && (_parameter_a418da4fProxy__ != nullptr));
                    if ((_parameter_a418da4f == nullptr) || (_parameter_a418da4fProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Unregister(_parameter_a418da4f);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_a418da4fProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_a418da4fProxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Register(Exchange::Dolby::IOutput::INotification* _parameter_5a12100d) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_5a12100d));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_5a12100d), Exchange::Dolby::IOutput::INotification::ID }, { 0, 0 } };
        ...
        uint32_t Unregister(Exchange::Dolby::IOutput::INotification* _parameter_a418da4f) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_a418da4f));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_a418da4f), Exchange::Dolby::IOutput::INotification::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
