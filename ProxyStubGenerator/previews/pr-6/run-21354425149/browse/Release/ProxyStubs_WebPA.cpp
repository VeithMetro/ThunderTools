...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeWebPAStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_f866baffInstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_f866baff{};
                ProxyStub::UnknownProxy* _parameter_f866baffProxy__ = nullptr;
                if (_parameter_f866baffInstanceId__ != 0) {
                    _parameter_f866baffProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_f866baffInstanceId__, false, _parameter_f866baff);
                    ASSERT((_parameter_f866baff != nullptr) && (_parameter_f866baffProxy__ != nullptr));
                    if ((_parameter_f866baff == nullptr) || (_parameter_f866baffProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Initialize(_parameter_f866baff);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_f866baffProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_f866baffProxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_78b26655InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_78b26655{};
                ProxyStub::UnknownProxy* _parameter_78b26655Proxy__ = nullptr;
                if (_parameter_78b26655InstanceId__ != 0) {
                    _parameter_78b26655Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_78b26655InstanceId__, false, _parameter_78b26655);
                    ASSERT((_parameter_78b26655 != nullptr) && (_parameter_78b26655Proxy__ != nullptr));
                    if ((_parameter_78b26655 == nullptr) || (_parameter_78b26655Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Deinitialize(_parameter_78b26655);

                if (_parameter_78b26655Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_78b26655Proxy__, message->Response());
                }
    ...
    static ProxyStub::MethodHandler ExchangeWebPAWebPAClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_fcc35815InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_fcc35815{};
                ProxyStub::UnknownProxy* _parameter_fcc35815Proxy__ = nullptr;
                if (_parameter_fcc35815InstanceId__ != 0) {
                    _parameter_fcc35815Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_fcc35815InstanceId__, false, _parameter_fcc35815);
                    ASSERT((_parameter_fcc35815 != nullptr) && (_parameter_fcc35815Proxy__ != nullptr));
                    if ((_parameter_fcc35815 == nullptr) || (_parameter_fcc35815Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Configure(_parameter_fcc35815);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_fcc35815Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_fcc35815Proxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Initialize(PluginHost::IShell* _parameter_f866baff) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_f866baff));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_f866baff), PluginHost::IShell::ID }, { 0, 0 } };
        ...
        void Deinitialize(PluginHost::IShell* _parameter_78b26655) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_78b26655));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_78b26655), PluginHost::IShell::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_fcc35815) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_fcc35815));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_fcc35815), PluginHost::IShell::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
