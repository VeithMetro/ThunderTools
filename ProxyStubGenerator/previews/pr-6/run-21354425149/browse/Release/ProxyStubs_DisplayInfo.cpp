...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeConnectionPropertiesStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_4dc19498InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IConnectionProperties::INotification* _parameter_4dc19498{};
                ProxyStub::UnknownProxy* _parameter_4dc19498Proxy__ = nullptr;
                if (_parameter_4dc19498InstanceId__ != 0) {
                    _parameter_4dc19498Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_4dc19498InstanceId__, false, _parameter_4dc19498);
                    ASSERT((_parameter_4dc19498 != nullptr) && (_parameter_4dc19498Proxy__ != nullptr));
                    if ((_parameter_4dc19498 == nullptr) || (_parameter_4dc19498Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Register(_parameter_4dc19498);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_4dc19498Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_4dc19498Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_8928b305InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IConnectionProperties::INotification* _parameter_8928b305{};
                ProxyStub::UnknownProxy* _parameter_8928b305Proxy__ = nullptr;
                if (_parameter_8928b305InstanceId__ != 0) {
                    _parameter_8928b305Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_8928b305InstanceId__, false, _parameter_8928b305);
                    ASSERT((_parameter_8928b305 != nullptr) && (_parameter_8928b305Proxy__ != nullptr));
                    if ((_parameter_8928b305 == nullptr) || (_parameter_8928b305Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Unregister(_parameter_8928b305);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_8928b305Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_8928b305Proxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Register(Exchange::IConnectionProperties::INotification* _parameter_4dc19498) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_4dc19498));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_4dc19498), Exchange::IConnectionProperties::INotification::ID }, { 0, 0 } };
        ...
        uint32_t Unregister(Exchange::IConnectionProperties::INotification* _parameter_8928b305) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_8928b305));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_8928b305), Exchange::IConnectionProperties::INotification::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
