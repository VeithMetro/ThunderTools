...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeConnectionPropertiesStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_1cc28539InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_1cc28539{};
            ProxyStub::UnknownProxy* _parameter_1cc28539Proxy__ = nullptr;
            if (_parameter_1cc28539InstanceId__ != 0) {
                _parameter_1cc28539Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_1cc28539InstanceId__, false, _parameter_1cc28539);
                ASSERT((_parameter_1cc28539 != nullptr) && (_parameter_1cc28539Proxy__ != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_1cc28539);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_1cc28539Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_1cc28539Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_dbd47d79InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_dbd47d79{};
            ProxyStub::UnknownProxy* _parameter_dbd47d79Proxy__ = nullptr;
            if (_parameter_dbd47d79InstanceId__ != 0) {
                _parameter_dbd47d79Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_dbd47d79InstanceId__, false, _parameter_dbd47d79);
                ASSERT((_parameter_dbd47d79 != nullptr) && (_parameter_dbd47d79Proxy__ != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_dbd47d79);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_dbd47d79Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_dbd47d79Proxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Register(Exchange::IConnectionProperties::INotification* _parameter_1cc28539) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_1cc28539));
        ...
        uint32_t Unregister(Exchange::IConnectionProperties::INotification* _parameter_dbd47d79) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_dbd47d79));
