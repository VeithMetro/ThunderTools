...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeSessionStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const string _parameter_557b079c = reader.Text();
            const string _parameter_65f5a58d = reader.Text();

            Exchange::OCDM_RESULT result = implementation->SetParameter(static_cast<const string&>(_parameter_557b079c), static_cast<const string&>(_parameter_65f5a58d));
    ...
    public:
        ...
        Exchange::OCDM_RESULT SetParameter(const string& _parameter_557b079c, const string& _parameter_65f5a58d) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(13));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_557b079c);
            writer.Text(_parameter_65f5a58d);
