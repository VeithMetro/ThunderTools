...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangePlayGigaStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            const string _parameter_66c46f3d = reader.Text();
            const string _parameter_27fe7c1f = reader.Text();

            implementation->Launch(static_cast<const string&>(_parameter_66c46f3d), static_cast<const string&>(_parameter_27fe7c1f));
        }
        , nullptr
    ...
    public:
        ...
        void Launch(const string& _parameter_66c46f3d, const string& _parameter_27fe7c1f) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_66c46f3d);
            writer.Text(_parameter_27fe7c1f);
