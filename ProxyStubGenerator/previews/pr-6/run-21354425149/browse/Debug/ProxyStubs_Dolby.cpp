...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeDolbyOutputStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_94c0a47cInstanceId__ = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_94c0a47c{};
            ProxyStub::UnknownProxy* _parameter_94c0a47cProxy__ = nullptr;
            if (_parameter_94c0a47cInstanceId__ != 0) {
                _parameter_94c0a47cProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_94c0a47cInstanceId__, false, _parameter_94c0a47c);
                ASSERT((_parameter_94c0a47c != nullptr) && (_parameter_94c0a47cProxy__ != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_94c0a47c);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_94c0a47cProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_94c0a47cProxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_b131dc17InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_b131dc17{};
            ProxyStub::UnknownProxy* _parameter_b131dc17Proxy__ = nullptr;
            if (_parameter_b131dc17InstanceId__ != 0) {
                _parameter_b131dc17Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_b131dc17InstanceId__, false, _parameter_b131dc17);
                ASSERT((_parameter_b131dc17 != nullptr) && (_parameter_b131dc17Proxy__ != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_b131dc17);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_b131dc17Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_b131dc17Proxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Register(Exchange::Dolby::IOutput::INotification* _parameter_94c0a47c) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_94c0a47c));
        ...
        uint32_t Unregister(Exchange::Dolby::IOutput::INotification* _parameter_b131dc17) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_b131dc17));
