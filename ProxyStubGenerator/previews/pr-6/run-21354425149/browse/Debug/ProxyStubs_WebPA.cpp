...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeWebPAStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_bbb9b423InstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_bbb9b423{};
            ProxyStub::UnknownProxy* _parameter_bbb9b423Proxy__ = nullptr;
            if (_parameter_bbb9b423InstanceId__ != 0) {
                _parameter_bbb9b423Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_bbb9b423InstanceId__, false, _parameter_bbb9b423);
                ASSERT((_parameter_bbb9b423 != nullptr) && (_parameter_bbb9b423Proxy__ != nullptr));
            }

            uint32_t result = implementation->Initialize(_parameter_bbb9b423);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_bbb9b423Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_bbb9b423Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_f5e1d657InstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_f5e1d657{};
            ProxyStub::UnknownProxy* _parameter_f5e1d657Proxy__ = nullptr;
            if (_parameter_f5e1d657InstanceId__ != 0) {
                _parameter_f5e1d657Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_f5e1d657InstanceId__, false, _parameter_f5e1d657);
                ASSERT((_parameter_f5e1d657 != nullptr) && (_parameter_f5e1d657Proxy__ != nullptr));
            }

            implementation->Deinitialize(_parameter_f5e1d657);

            if (_parameter_f5e1d657Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_f5e1d657Proxy__, message->Response());
            }
        },
    ...
    static ProxyStub::MethodHandler ExchangeWebPAWebPAClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_efd1cb7fInstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_efd1cb7f{};
            ProxyStub::UnknownProxy* _parameter_efd1cb7fProxy__ = nullptr;
            if (_parameter_efd1cb7fInstanceId__ != 0) {
                _parameter_efd1cb7fProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_efd1cb7fInstanceId__, false, _parameter_efd1cb7f);
                ASSERT((_parameter_efd1cb7f != nullptr) && (_parameter_efd1cb7fProxy__ != nullptr));
            }

            uint32_t result = implementation->Configure(_parameter_efd1cb7f);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_efd1cb7fProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_efd1cb7fProxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Initialize(PluginHost::IShell* _parameter_bbb9b423) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_bbb9b423));
        ...
        void Deinitialize(PluginHost::IShell* _parameter_f5e1d657) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_f5e1d657));
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_efd1cb7f) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_efd1cb7f));
