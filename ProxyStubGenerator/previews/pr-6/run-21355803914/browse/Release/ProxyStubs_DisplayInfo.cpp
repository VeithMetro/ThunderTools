...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeConnectionPropertiesStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_ce0bf638InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IConnectionProperties::INotification* _parameter_ce0bf638{};
                ProxyStub::UnknownProxy* _parameter_ce0bf638Proxy__ = nullptr;
                if (_parameter_ce0bf638InstanceId__ != 0) {
                    _parameter_ce0bf638Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_ce0bf638InstanceId__, false, _parameter_ce0bf638);
                    ASSERT((_parameter_ce0bf638 != nullptr) && (_parameter_ce0bf638Proxy__ != nullptr));
                    if ((_parameter_ce0bf638 == nullptr) || (_parameter_ce0bf638Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Register(_parameter_ce0bf638);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_ce0bf638Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_ce0bf638Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_e96acedaInstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IConnectionProperties::INotification* _parameter_e96aceda{};
                ProxyStub::UnknownProxy* _parameter_e96acedaProxy__ = nullptr;
                if (_parameter_e96acedaInstanceId__ != 0) {
                    _parameter_e96acedaProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_e96acedaInstanceId__, false, _parameter_e96aceda);
                    ASSERT((_parameter_e96aceda != nullptr) && (_parameter_e96acedaProxy__ != nullptr));
                    if ((_parameter_e96aceda == nullptr) || (_parameter_e96acedaProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Unregister(_parameter_e96aceda);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_e96acedaProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_e96acedaProxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Register(Exchange::IConnectionProperties::INotification* _parameter_ce0bf638) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_ce0bf638));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_ce0bf638), Exchange::IConnectionProperties::INotification::ID }, { 0, 0 } };
        ...
        uint32_t Unregister(Exchange::IConnectionProperties::INotification* _parameter_e96aceda) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_e96aceda));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_e96aceda), Exchange::IConnectionProperties::INotification::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
