...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeWebPAStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_bb7b0f0eInstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_bb7b0f0e{};
                ProxyStub::UnknownProxy* _parameter_bb7b0f0eProxy__ = nullptr;
                if (_parameter_bb7b0f0eInstanceId__ != 0) {
                    _parameter_bb7b0f0eProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_bb7b0f0eInstanceId__, false, _parameter_bb7b0f0e);
                    ASSERT((_parameter_bb7b0f0e != nullptr) && (_parameter_bb7b0f0eProxy__ != nullptr));
                    if ((_parameter_bb7b0f0e == nullptr) || (_parameter_bb7b0f0eProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Initialize(_parameter_bb7b0f0e);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_bb7b0f0eProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_bb7b0f0eProxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_48c8b2f7InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_48c8b2f7{};
                ProxyStub::UnknownProxy* _parameter_48c8b2f7Proxy__ = nullptr;
                if (_parameter_48c8b2f7InstanceId__ != 0) {
                    _parameter_48c8b2f7Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_48c8b2f7InstanceId__, false, _parameter_48c8b2f7);
                    ASSERT((_parameter_48c8b2f7 != nullptr) && (_parameter_48c8b2f7Proxy__ != nullptr));
                    if ((_parameter_48c8b2f7 == nullptr) || (_parameter_48c8b2f7Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Deinitialize(_parameter_48c8b2f7);

                if (_parameter_48c8b2f7Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_48c8b2f7Proxy__, message->Response());
                }
    ...
    static ProxyStub::MethodHandler ExchangeWebPAWebPAClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_5e30d9dfInstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_5e30d9df{};
                ProxyStub::UnknownProxy* _parameter_5e30d9dfProxy__ = nullptr;
                if (_parameter_5e30d9dfInstanceId__ != 0) {
                    _parameter_5e30d9dfProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_5e30d9dfInstanceId__, false, _parameter_5e30d9df);
                    ASSERT((_parameter_5e30d9df != nullptr) && (_parameter_5e30d9dfProxy__ != nullptr));
                    if ((_parameter_5e30d9df == nullptr) || (_parameter_5e30d9dfProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Configure(_parameter_5e30d9df);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_5e30d9dfProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_5e30d9dfProxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Initialize(PluginHost::IShell* _parameter_bb7b0f0e) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_bb7b0f0e));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_bb7b0f0e), PluginHost::IShell::ID }, { 0, 0 } };
        ...
        void Deinitialize(PluginHost::IShell* _parameter_48c8b2f7) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_48c8b2f7));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_48c8b2f7), PluginHost::IShell::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_5e30d9df) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_5e30d9df));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_5e30d9df), PluginHost::IShell::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
