...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeDolbyOutputStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_bc1adb29InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::Dolby::IOutput::INotification* _parameter_bc1adb29{};
                ProxyStub::UnknownProxy* _parameter_bc1adb29Proxy__ = nullptr;
                if (_parameter_bc1adb29InstanceId__ != 0) {
                    _parameter_bc1adb29Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_bc1adb29InstanceId__, false, _parameter_bc1adb29);
                    ASSERT((_parameter_bc1adb29 != nullptr) && (_parameter_bc1adb29Proxy__ != nullptr));
                    if ((_parameter_bc1adb29 == nullptr) || (_parameter_bc1adb29Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Register(_parameter_bc1adb29);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_bc1adb29Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_bc1adb29Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_66e75a07InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::Dolby::IOutput::INotification* _parameter_66e75a07{};
                ProxyStub::UnknownProxy* _parameter_66e75a07Proxy__ = nullptr;
                if (_parameter_66e75a07InstanceId__ != 0) {
                    _parameter_66e75a07Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_66e75a07InstanceId__, false, _parameter_66e75a07);
                    ASSERT((_parameter_66e75a07 != nullptr) && (_parameter_66e75a07Proxy__ != nullptr));
                    if ((_parameter_66e75a07 == nullptr) || (_parameter_66e75a07Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Unregister(_parameter_66e75a07);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_66e75a07Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_66e75a07Proxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Register(Exchange::Dolby::IOutput::INotification* _parameter_bc1adb29) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_bc1adb29));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_bc1adb29), Exchange::Dolby::IOutput::INotification::ID }, { 0, 0 } };
        ...
        uint32_t Unregister(Exchange::Dolby::IOutput::INotification* _parameter_66e75a07) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_66e75a07));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_66e75a07), Exchange::Dolby::IOutput::INotification::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
