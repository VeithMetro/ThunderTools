...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeStreamStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_073dd1aaInstanceId__ = reader.Number<Core::instance_id>();

            Exchange::IStream::ICallback* _parameter_073dd1aa{};
            ProxyStub::UnknownProxy* _parameter_073dd1aaProxy__ = nullptr;
            if (_parameter_073dd1aaInstanceId__ != 0) {
                _parameter_073dd1aaProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_073dd1aaInstanceId__, false, _parameter_073dd1aa);
                ASSERT((_parameter_073dd1aa != nullptr) && (_parameter_073dd1aaProxy__ != nullptr));
            }

            implementation->Callback(_parameter_073dd1aa);

            if (_parameter_073dd1aaProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_073dd1aaProxy__, message->Response());
            }
        },
    ...
    public:
        ...
        void Callback(Exchange::IStream::ICallback* _parameter_073dd1aa) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(4));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_073dd1aa));
