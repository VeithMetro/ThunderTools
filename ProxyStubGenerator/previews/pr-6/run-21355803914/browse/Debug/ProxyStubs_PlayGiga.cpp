...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangePlayGigaStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            const string _parameter_a3fa96bf = reader.Text();
            const string _parameter_fd27291e = reader.Text();

            implementation->Launch(static_cast<const string&>(_parameter_a3fa96bf), static_cast<const string&>(_parameter_fd27291e));
        }
        , nullptr
    ...
    public:
        ...
        void Launch(const string& _parameter_a3fa96bf, const string& _parameter_fd27291e) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_a3fa96bf);
            writer.Text(_parameter_fd27291e);
