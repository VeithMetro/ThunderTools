...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeConnectionPropertiesStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_49246a3fInstanceId__ = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_49246a3f{};
            ProxyStub::UnknownProxy* _parameter_49246a3fProxy__ = nullptr;
            if (_parameter_49246a3fInstanceId__ != 0) {
                _parameter_49246a3fProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_49246a3fInstanceId__, false, _parameter_49246a3f);
                ASSERT((_parameter_49246a3f != nullptr) && (_parameter_49246a3fProxy__ != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_49246a3f);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_49246a3fProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_49246a3fProxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_2604bf69InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_2604bf69{};
            ProxyStub::UnknownProxy* _parameter_2604bf69Proxy__ = nullptr;
            if (_parameter_2604bf69InstanceId__ != 0) {
                _parameter_2604bf69Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_2604bf69InstanceId__, false, _parameter_2604bf69);
                ASSERT((_parameter_2604bf69 != nullptr) && (_parameter_2604bf69Proxy__ != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_2604bf69);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_2604bf69Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_2604bf69Proxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Register(Exchange::IConnectionProperties::INotification* _parameter_49246a3f) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_49246a3f));
        ...
        uint32_t Unregister(Exchange::IConnectionProperties::INotification* _parameter_2604bf69) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_2604bf69));
