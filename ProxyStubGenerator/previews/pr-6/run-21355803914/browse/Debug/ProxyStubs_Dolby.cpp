...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeDolbyOutputStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_79bfacb4InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_79bfacb4{};
            ProxyStub::UnknownProxy* _parameter_79bfacb4Proxy__ = nullptr;
            if (_parameter_79bfacb4InstanceId__ != 0) {
                _parameter_79bfacb4Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_79bfacb4InstanceId__, false, _parameter_79bfacb4);
                ASSERT((_parameter_79bfacb4 != nullptr) && (_parameter_79bfacb4Proxy__ != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_79bfacb4);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_79bfacb4Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_79bfacb4Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_c8b81a0cInstanceId__ = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_c8b81a0c{};
            ProxyStub::UnknownProxy* _parameter_c8b81a0cProxy__ = nullptr;
            if (_parameter_c8b81a0cInstanceId__ != 0) {
                _parameter_c8b81a0cProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_c8b81a0cInstanceId__, false, _parameter_c8b81a0c);
                ASSERT((_parameter_c8b81a0c != nullptr) && (_parameter_c8b81a0cProxy__ != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_c8b81a0c);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_c8b81a0cProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_c8b81a0cProxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Register(Exchange::Dolby::IOutput::INotification* _parameter_79bfacb4) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_79bfacb4));
        ...
        uint32_t Unregister(Exchange::Dolby::IOutput::INotification* _parameter_c8b81a0c) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_c8b81a0c));
