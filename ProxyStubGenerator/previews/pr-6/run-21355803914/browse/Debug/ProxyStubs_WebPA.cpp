...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeWebPAStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_17e1797dInstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_17e1797d{};
            ProxyStub::UnknownProxy* _parameter_17e1797dProxy__ = nullptr;
            if (_parameter_17e1797dInstanceId__ != 0) {
                _parameter_17e1797dProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_17e1797dInstanceId__, false, _parameter_17e1797d);
                ASSERT((_parameter_17e1797d != nullptr) && (_parameter_17e1797dProxy__ != nullptr));
            }

            uint32_t result = implementation->Initialize(_parameter_17e1797d);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_17e1797dProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_17e1797dProxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_975282bbInstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_975282bb{};
            ProxyStub::UnknownProxy* _parameter_975282bbProxy__ = nullptr;
            if (_parameter_975282bbInstanceId__ != 0) {
                _parameter_975282bbProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_975282bbInstanceId__, false, _parameter_975282bb);
                ASSERT((_parameter_975282bb != nullptr) && (_parameter_975282bbProxy__ != nullptr));
            }

            implementation->Deinitialize(_parameter_975282bb);

            if (_parameter_975282bbProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_975282bbProxy__, message->Response());
            }
        },
    ...
    static ProxyStub::MethodHandler ExchangeWebPAWebPAClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_871ec319InstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_871ec319{};
            ProxyStub::UnknownProxy* _parameter_871ec319Proxy__ = nullptr;
            if (_parameter_871ec319InstanceId__ != 0) {
                _parameter_871ec319Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_871ec319InstanceId__, false, _parameter_871ec319);
                ASSERT((_parameter_871ec319 != nullptr) && (_parameter_871ec319Proxy__ != nullptr));
            }

            uint32_t result = implementation->Configure(_parameter_871ec319);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_871ec319Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_871ec319Proxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Initialize(PluginHost::IShell* _parameter_17e1797d) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_17e1797d));
        ...
        void Deinitialize(PluginHost::IShell* _parameter_975282bb) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_975282bb));
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_871ec319) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_871ec319));
