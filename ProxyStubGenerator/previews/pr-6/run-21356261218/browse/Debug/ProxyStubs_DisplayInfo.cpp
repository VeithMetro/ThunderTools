...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeConnectionPropertiesStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_3d43a7edInstanceId__ = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_3d43a7ed{};
            ProxyStub::UnknownProxy* _parameter_3d43a7edProxy__ = nullptr;
            if (_parameter_3d43a7edInstanceId__ != 0) {
                _parameter_3d43a7edProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_3d43a7edInstanceId__, false, _parameter_3d43a7ed);
                ASSERT((_parameter_3d43a7ed != nullptr) && (_parameter_3d43a7edProxy__ != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_3d43a7ed);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_3d43a7edProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_3d43a7edProxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_de002ab7InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_de002ab7{};
            ProxyStub::UnknownProxy* _parameter_de002ab7Proxy__ = nullptr;
            if (_parameter_de002ab7InstanceId__ != 0) {
                _parameter_de002ab7Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_de002ab7InstanceId__, false, _parameter_de002ab7);
                ASSERT((_parameter_de002ab7 != nullptr) && (_parameter_de002ab7Proxy__ != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_de002ab7);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_de002ab7Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_de002ab7Proxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Register(Exchange::IConnectionProperties::INotification* _parameter_3d43a7ed) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_3d43a7ed));
        ...
        uint32_t Unregister(Exchange::IConnectionProperties::INotification* _parameter_de002ab7) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_de002ab7));
