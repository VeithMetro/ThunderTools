...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeStreamStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_10e4d5ddInstanceId__ = reader.Number<Core::instance_id>();

            Exchange::IStream::ICallback* _parameter_10e4d5dd{};
            ProxyStub::UnknownProxy* _parameter_10e4d5ddProxy__ = nullptr;
            if (_parameter_10e4d5ddInstanceId__ != 0) {
                _parameter_10e4d5ddProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_10e4d5ddInstanceId__, false, _parameter_10e4d5dd);
                ASSERT((_parameter_10e4d5dd != nullptr) && (_parameter_10e4d5ddProxy__ != nullptr));
            }

            implementation->Callback(_parameter_10e4d5dd);

            if (_parameter_10e4d5ddProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_10e4d5ddProxy__, message->Response());
            }
        },
    ...
    public:
        ...
        void Callback(Exchange::IStream::ICallback* _parameter_10e4d5dd) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(4));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_10e4d5dd));
