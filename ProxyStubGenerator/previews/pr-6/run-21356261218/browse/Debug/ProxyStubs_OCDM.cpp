...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeSessionStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const string _parameter_d2d02b09 = reader.Text();
            const string _parameter_7d90bffd = reader.Text();

            Exchange::OCDM_RESULT result = implementation->SetParameter(static_cast<const string&>(_parameter_d2d02b09), static_cast<const string&>(_parameter_7d90bffd));
    ...
    public:
        ...
        Exchange::OCDM_RESULT SetParameter(const string& _parameter_d2d02b09, const string& _parameter_7d90bffd) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(13));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_d2d02b09);
            writer.Text(_parameter_7d90bffd);
