...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangePlayGigaStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            const string _parameter_9463d683 = reader.Text();
            const string _parameter_719bc21e = reader.Text();

            implementation->Launch(static_cast<const string&>(_parameter_9463d683), static_cast<const string&>(_parameter_719bc21e));
        }
        , nullptr
    ...
    public:
        ...
        void Launch(const string& _parameter_9463d683, const string& _parameter_719bc21e) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_9463d683);
            writer.Text(_parameter_719bc21e);
