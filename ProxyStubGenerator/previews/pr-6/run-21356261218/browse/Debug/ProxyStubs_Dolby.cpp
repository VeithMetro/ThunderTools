...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeDolbyOutputStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_a5d2ad6fInstanceId__ = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_a5d2ad6f{};
            ProxyStub::UnknownProxy* _parameter_a5d2ad6fProxy__ = nullptr;
            if (_parameter_a5d2ad6fInstanceId__ != 0) {
                _parameter_a5d2ad6fProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_a5d2ad6fInstanceId__, false, _parameter_a5d2ad6f);
                ASSERT((_parameter_a5d2ad6f != nullptr) && (_parameter_a5d2ad6fProxy__ != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_a5d2ad6f);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_a5d2ad6fProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_a5d2ad6fProxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_dd249b2eInstanceId__ = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_dd249b2e{};
            ProxyStub::UnknownProxy* _parameter_dd249b2eProxy__ = nullptr;
            if (_parameter_dd249b2eInstanceId__ != 0) {
                _parameter_dd249b2eProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_dd249b2eInstanceId__, false, _parameter_dd249b2e);
                ASSERT((_parameter_dd249b2e != nullptr) && (_parameter_dd249b2eProxy__ != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_dd249b2e);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_dd249b2eProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_dd249b2eProxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Register(Exchange::Dolby::IOutput::INotification* _parameter_a5d2ad6f) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_a5d2ad6f));
        ...
        uint32_t Unregister(Exchange::Dolby::IOutput::INotification* _parameter_dd249b2e) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_dd249b2e));
