...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeConnectionPropertiesStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_4cbec719InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IConnectionProperties::INotification* _parameter_4cbec719{};
                ProxyStub::UnknownProxy* _parameter_4cbec719Proxy__ = nullptr;
                if (_parameter_4cbec719InstanceId__ != 0) {
                    _parameter_4cbec719Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_4cbec719InstanceId__, false, _parameter_4cbec719);
                    ASSERT((_parameter_4cbec719 != nullptr) && (_parameter_4cbec719Proxy__ != nullptr));
                    if ((_parameter_4cbec719 == nullptr) || (_parameter_4cbec719Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Register(_parameter_4cbec719);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_4cbec719Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_4cbec719Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_25143d78InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IConnectionProperties::INotification* _parameter_25143d78{};
                ProxyStub::UnknownProxy* _parameter_25143d78Proxy__ = nullptr;
                if (_parameter_25143d78InstanceId__ != 0) {
                    _parameter_25143d78Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_25143d78InstanceId__, false, _parameter_25143d78);
                    ASSERT((_parameter_25143d78 != nullptr) && (_parameter_25143d78Proxy__ != nullptr));
                    if ((_parameter_25143d78 == nullptr) || (_parameter_25143d78Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Unregister(_parameter_25143d78);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_25143d78Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_25143d78Proxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Register(Exchange::IConnectionProperties::INotification* _parameter_4cbec719) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_4cbec719));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_4cbec719), Exchange::IConnectionProperties::INotification::ID }, { 0, 0 } };
        ...
        uint32_t Unregister(Exchange::IConnectionProperties::INotification* _parameter_25143d78) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_25143d78));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_25143d78), Exchange::IConnectionProperties::INotification::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
