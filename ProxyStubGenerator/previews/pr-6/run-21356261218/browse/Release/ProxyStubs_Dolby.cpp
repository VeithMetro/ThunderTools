...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeDolbyOutputStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_f4f7b3f7InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::Dolby::IOutput::INotification* _parameter_f4f7b3f7{};
                ProxyStub::UnknownProxy* _parameter_f4f7b3f7Proxy__ = nullptr;
                if (_parameter_f4f7b3f7InstanceId__ != 0) {
                    _parameter_f4f7b3f7Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_f4f7b3f7InstanceId__, false, _parameter_f4f7b3f7);
                    ASSERT((_parameter_f4f7b3f7 != nullptr) && (_parameter_f4f7b3f7Proxy__ != nullptr));
                    if ((_parameter_f4f7b3f7 == nullptr) || (_parameter_f4f7b3f7Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Register(_parameter_f4f7b3f7);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_f4f7b3f7Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_f4f7b3f7Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_425d9a5bInstanceId__ = reader.Number<Core::instance_id>();

                Exchange::Dolby::IOutput::INotification* _parameter_425d9a5b{};
                ProxyStub::UnknownProxy* _parameter_425d9a5bProxy__ = nullptr;
                if (_parameter_425d9a5bInstanceId__ != 0) {
                    _parameter_425d9a5bProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_425d9a5bInstanceId__, false, _parameter_425d9a5b);
                    ASSERT((_parameter_425d9a5b != nullptr) && (_parameter_425d9a5bProxy__ != nullptr));
                    if ((_parameter_425d9a5b == nullptr) || (_parameter_425d9a5bProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Unregister(_parameter_425d9a5b);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_425d9a5bProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_425d9a5bProxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Register(Exchange::Dolby::IOutput::INotification* _parameter_f4f7b3f7) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_f4f7b3f7));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_f4f7b3f7), Exchange::Dolby::IOutput::INotification::ID }, { 0, 0 } };
        ...
        uint32_t Unregister(Exchange::Dolby::IOutput::INotification* _parameter_425d9a5b) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_425d9a5b));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_425d9a5b), Exchange::Dolby::IOutput::INotification::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
