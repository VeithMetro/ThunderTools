...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeWebPAStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_0cf2b496InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_0cf2b496{};
                ProxyStub::UnknownProxy* _parameter_0cf2b496Proxy__ = nullptr;
                if (_parameter_0cf2b496InstanceId__ != 0) {
                    _parameter_0cf2b496Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_0cf2b496InstanceId__, false, _parameter_0cf2b496);
                    ASSERT((_parameter_0cf2b496 != nullptr) && (_parameter_0cf2b496Proxy__ != nullptr));
                    if ((_parameter_0cf2b496 == nullptr) || (_parameter_0cf2b496Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Initialize(_parameter_0cf2b496);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_0cf2b496Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_0cf2b496Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_070f68b7InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_070f68b7{};
                ProxyStub::UnknownProxy* _parameter_070f68b7Proxy__ = nullptr;
                if (_parameter_070f68b7InstanceId__ != 0) {
                    _parameter_070f68b7Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_070f68b7InstanceId__, false, _parameter_070f68b7);
                    ASSERT((_parameter_070f68b7 != nullptr) && (_parameter_070f68b7Proxy__ != nullptr));
                    if ((_parameter_070f68b7 == nullptr) || (_parameter_070f68b7Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Deinitialize(_parameter_070f68b7);

                if (_parameter_070f68b7Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_070f68b7Proxy__, message->Response());
                }
    ...
    static ProxyStub::MethodHandler ExchangeWebPAWebPAClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_df4cb412InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_df4cb412{};
                ProxyStub::UnknownProxy* _parameter_df4cb412Proxy__ = nullptr;
                if (_parameter_df4cb412InstanceId__ != 0) {
                    _parameter_df4cb412Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_df4cb412InstanceId__, false, _parameter_df4cb412);
                    ASSERT((_parameter_df4cb412 != nullptr) && (_parameter_df4cb412Proxy__ != nullptr));
                    if ((_parameter_df4cb412 == nullptr) || (_parameter_df4cb412Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Configure(_parameter_df4cb412);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_df4cb412Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_df4cb412Proxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Initialize(PluginHost::IShell* _parameter_0cf2b496) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_0cf2b496));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_0cf2b496), PluginHost::IShell::ID }, { 0, 0 } };
        ...
        void Deinitialize(PluginHost::IShell* _parameter_070f68b7) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_070f68b7));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_070f68b7), PluginHost::IShell::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_df4cb412) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_df4cb412));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_df4cb412), PluginHost::IShell::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
