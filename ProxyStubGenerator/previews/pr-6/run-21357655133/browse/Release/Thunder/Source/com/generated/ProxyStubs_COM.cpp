...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler RemoteConnectionNotificationStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_e57af151InstanceId__ = reader.Number<Core::instance_id>();

                IRemoteConnection* _parameter_e57af151{};
                ProxyStub::UnknownProxy* _parameter_e57af151Proxy__ = nullptr;
                if (_parameter_e57af151InstanceId__ != 0) {
                    _parameter_e57af151Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_e57af151InstanceId__, false, _parameter_e57af151);
                    ASSERT((_parameter_e57af151 != nullptr) && (_parameter_e57af151Proxy__ != nullptr));
                    if ((_parameter_e57af151 == nullptr) || (_parameter_e57af151Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Activated(_parameter_e57af151);

                if (_parameter_e57af151Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_e57af151Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_8dedeb81InstanceId__ = reader.Number<Core::instance_id>();

                IRemoteConnection* _parameter_8dedeb81{};
                ProxyStub::UnknownProxy* _parameter_8dedeb81Proxy__ = nullptr;
                if (_parameter_8dedeb81InstanceId__ != 0) {
                    _parameter_8dedeb81Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_8dedeb81InstanceId__, false, _parameter_8dedeb81);
                    ASSERT((_parameter_8dedeb81 != nullptr) && (_parameter_8dedeb81Proxy__ != nullptr));
                    if ((_parameter_8dedeb81 == nullptr) || (_parameter_8dedeb81Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Deactivated(_parameter_8dedeb81);

                if (_parameter_8dedeb81Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_8dedeb81Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_4965a4eaInstanceId__ = reader.Number<Core::instance_id>();

                IRemoteConnection* _parameter_4965a4ea{};
                ProxyStub::UnknownProxy* _parameter_4965a4eaProxy__ = nullptr;
                if (_parameter_4965a4eaInstanceId__ != 0) {
                    _parameter_4965a4eaProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_4965a4eaInstanceId__, false, _parameter_4965a4ea);
                    ASSERT((_parameter_4965a4ea != nullptr) && (_parameter_4965a4eaProxy__ != nullptr));
                    if ((_parameter_4965a4ea == nullptr) || (_parameter_4965a4eaProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Terminated(_parameter_4965a4ea);

                if (_parameter_4965a4eaProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_4965a4eaProxy__, message->Response());
                }
    ...
    public:
        ...
        void Activated(IRemoteConnection* _parameter_e57af151) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_e57af151));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_e57af151), IRemoteConnection::ID }, { 0, 0 } };
        ...
        void Deactivated(IRemoteConnection* _parameter_8dedeb81) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_8dedeb81));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_8dedeb81), IRemoteConnection::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
        ...
        void Terminated(IRemoteConnection* _parameter_4965a4ea) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(2));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_4965a4ea));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_4965a4ea), IRemoteConnection::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
