...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeWebPAStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_1a740607InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_1a740607{};
                ProxyStub::UnknownProxy* _parameter_1a740607Proxy__ = nullptr;
                if (_parameter_1a740607InstanceId__ != 0) {
                    _parameter_1a740607Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_1a740607InstanceId__, false, _parameter_1a740607);
                    ASSERT((_parameter_1a740607 != nullptr) && (_parameter_1a740607Proxy__ != nullptr));
                    if ((_parameter_1a740607 == nullptr) || (_parameter_1a740607Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Initialize(_parameter_1a740607);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_1a740607Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_1a740607Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_fc27f336InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_fc27f336{};
                ProxyStub::UnknownProxy* _parameter_fc27f336Proxy__ = nullptr;
                if (_parameter_fc27f336InstanceId__ != 0) {
                    _parameter_fc27f336Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_fc27f336InstanceId__, false, _parameter_fc27f336);
                    ASSERT((_parameter_fc27f336 != nullptr) && (_parameter_fc27f336Proxy__ != nullptr));
                    if ((_parameter_fc27f336 == nullptr) || (_parameter_fc27f336Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Deinitialize(_parameter_fc27f336);

                if (_parameter_fc27f336Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_fc27f336Proxy__, message->Response());
                }
    ...
    static ProxyStub::MethodHandler ExchangeWebPAWebPAClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_b52a9a0bInstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_b52a9a0b{};
                ProxyStub::UnknownProxy* _parameter_b52a9a0bProxy__ = nullptr;
                if (_parameter_b52a9a0bInstanceId__ != 0) {
                    _parameter_b52a9a0bProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_b52a9a0bInstanceId__, false, _parameter_b52a9a0b);
                    ASSERT((_parameter_b52a9a0b != nullptr) && (_parameter_b52a9a0bProxy__ != nullptr));
                    if ((_parameter_b52a9a0b == nullptr) || (_parameter_b52a9a0bProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Configure(_parameter_b52a9a0b);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_b52a9a0bProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_b52a9a0bProxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Initialize(PluginHost::IShell* _parameter_1a740607) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_1a740607));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_1a740607), PluginHost::IShell::ID }, { 0, 0 } };
        ...
        void Deinitialize(PluginHost::IShell* _parameter_fc27f336) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_fc27f336));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_fc27f336), PluginHost::IShell::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_b52a9a0b) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_b52a9a0b));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_b52a9a0b), PluginHost::IShell::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
