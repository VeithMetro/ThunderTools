...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeApplicationStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                const Exchange::IApplication::launchpointtype _parameter_c079668a = reader.Number<Exchange::IApplication::launchpointtype>();

                uint32_t result = implementation->LaunchPoint(static_cast<const Exchange::IApplication::launchpointtype&>(_parameter_c079668a));
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                const bool _parameter_84b289c2 = reader.Boolean();

                uint32_t result = implementation->Visible(_parameter_84b289c2);
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (Core::RealSize<uint16_t>())) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                const uint16_t _parameter_ab7a1d15PeekedLen__ = reader.PeekNumber<uint16_t>();
                if (reader.Length() < (static_cast<uint32_t>(Core::RealSize<uint16_t>()) + _parameter_ab7a1d15PeekedLen__)) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                const string _parameter_ab7a1d15 = reader.Text();

                uint32_t result = implementation->Language(static_cast<const string&>(_parameter_ab7a1d15));
    ...
    public:
        ...
        uint32_t LaunchPoint(const Exchange::IApplication::launchpointtype& _parameter_c079668a) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(6));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Exchange::IApplication::launchpointtype>(_parameter_c079668a);
        ...
        uint32_t Visible(const bool _parameter_84b289c2) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(8));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Boolean(_parameter_84b289c2);
        ...
        uint32_t Language(const string& _parameter_ab7a1d15) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(10));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_ab7a1d15);
