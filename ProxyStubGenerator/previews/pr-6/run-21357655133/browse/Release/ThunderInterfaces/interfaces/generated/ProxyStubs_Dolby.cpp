...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeDolbyOutputStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_c76451e4InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::Dolby::IOutput::INotification* _parameter_c76451e4{};
                ProxyStub::UnknownProxy* _parameter_c76451e4Proxy__ = nullptr;
                if (_parameter_c76451e4InstanceId__ != 0) {
                    _parameter_c76451e4Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_c76451e4InstanceId__, false, _parameter_c76451e4);
                    ASSERT((_parameter_c76451e4 != nullptr) && (_parameter_c76451e4Proxy__ != nullptr));
                    if ((_parameter_c76451e4 == nullptr) || (_parameter_c76451e4Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Register(_parameter_c76451e4);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_c76451e4Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_c76451e4Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_d25ccff9InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::Dolby::IOutput::INotification* _parameter_d25ccff9{};
                ProxyStub::UnknownProxy* _parameter_d25ccff9Proxy__ = nullptr;
                if (_parameter_d25ccff9InstanceId__ != 0) {
                    _parameter_d25ccff9Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_d25ccff9InstanceId__, false, _parameter_d25ccff9);
                    ASSERT((_parameter_d25ccff9 != nullptr) && (_parameter_d25ccff9Proxy__ != nullptr));
                    if ((_parameter_d25ccff9 == nullptr) || (_parameter_d25ccff9Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Unregister(_parameter_d25ccff9);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_d25ccff9Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_d25ccff9Proxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Register(Exchange::Dolby::IOutput::INotification* _parameter_c76451e4) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_c76451e4));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_c76451e4), Exchange::Dolby::IOutput::INotification::ID }, { 0, 0 } };
        ...
        uint32_t Unregister(Exchange::Dolby::IOutput::INotification* _parameter_d25ccff9) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_d25ccff9));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_d25ccff9), Exchange::Dolby::IOutput::INotification::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
