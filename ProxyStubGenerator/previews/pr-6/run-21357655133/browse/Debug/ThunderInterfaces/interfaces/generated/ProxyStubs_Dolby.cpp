...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeDolbyOutputStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_36ddf4faInstanceId__ = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_36ddf4fa{};
            ProxyStub::UnknownProxy* _parameter_36ddf4faProxy__ = nullptr;
            if (_parameter_36ddf4faInstanceId__ != 0) {
                _parameter_36ddf4faProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_36ddf4faInstanceId__, false, _parameter_36ddf4fa);
                ASSERT((_parameter_36ddf4fa != nullptr) && (_parameter_36ddf4faProxy__ != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_36ddf4fa);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_36ddf4faProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_36ddf4faProxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_0da64b99InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_0da64b99{};
            ProxyStub::UnknownProxy* _parameter_0da64b99Proxy__ = nullptr;
            if (_parameter_0da64b99InstanceId__ != 0) {
                _parameter_0da64b99Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_0da64b99InstanceId__, false, _parameter_0da64b99);
                ASSERT((_parameter_0da64b99 != nullptr) && (_parameter_0da64b99Proxy__ != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_0da64b99);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_0da64b99Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_0da64b99Proxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Register(Exchange::Dolby::IOutput::INotification* _parameter_36ddf4fa) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_36ddf4fa));
        ...
        uint32_t Unregister(Exchange::Dolby::IOutput::INotification* _parameter_0da64b99) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_0da64b99));
