...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangePlayGigaStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            const string _parameter_82d1234c = reader.Text();
            const string _parameter_31da437c = reader.Text();

            implementation->Launch(static_cast<const string&>(_parameter_82d1234c), static_cast<const string&>(_parameter_31da437c));
        }
        , nullptr
    ...
    public:
        ...
        void Launch(const string& _parameter_82d1234c, const string& _parameter_31da437c) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_82d1234c);
            writer.Text(_parameter_31da437c);
