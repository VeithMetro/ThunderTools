...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeWebPAStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_3adf5fe6InstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_3adf5fe6{};
            ProxyStub::UnknownProxy* _parameter_3adf5fe6Proxy__ = nullptr;
            if (_parameter_3adf5fe6InstanceId__ != 0) {
                _parameter_3adf5fe6Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_3adf5fe6InstanceId__, false, _parameter_3adf5fe6);
                ASSERT((_parameter_3adf5fe6 != nullptr) && (_parameter_3adf5fe6Proxy__ != nullptr));
            }

            uint32_t result = implementation->Initialize(_parameter_3adf5fe6);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_3adf5fe6Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_3adf5fe6Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_4ec418e1InstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_4ec418e1{};
            ProxyStub::UnknownProxy* _parameter_4ec418e1Proxy__ = nullptr;
            if (_parameter_4ec418e1InstanceId__ != 0) {
                _parameter_4ec418e1Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_4ec418e1InstanceId__, false, _parameter_4ec418e1);
                ASSERT((_parameter_4ec418e1 != nullptr) && (_parameter_4ec418e1Proxy__ != nullptr));
            }

            implementation->Deinitialize(_parameter_4ec418e1);

            if (_parameter_4ec418e1Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_4ec418e1Proxy__, message->Response());
            }
        },
    ...
    static ProxyStub::MethodHandler ExchangeWebPAWebPAClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_3d4e194aInstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_3d4e194a{};
            ProxyStub::UnknownProxy* _parameter_3d4e194aProxy__ = nullptr;
            if (_parameter_3d4e194aInstanceId__ != 0) {
                _parameter_3d4e194aProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_3d4e194aInstanceId__, false, _parameter_3d4e194a);
                ASSERT((_parameter_3d4e194a != nullptr) && (_parameter_3d4e194aProxy__ != nullptr));
            }

            uint32_t result = implementation->Configure(_parameter_3d4e194a);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_3d4e194aProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_3d4e194aProxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Initialize(PluginHost::IShell* _parameter_3adf5fe6) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_3adf5fe6));
        ...
        void Deinitialize(PluginHost::IShell* _parameter_4ec418e1) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_4ec418e1));
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_3d4e194a) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_3d4e194a));
