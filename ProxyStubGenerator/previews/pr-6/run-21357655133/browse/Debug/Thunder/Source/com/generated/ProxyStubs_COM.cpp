...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler RemoteConnectionNotificationStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_733d6c34InstanceId__ = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_733d6c34{};
            ProxyStub::UnknownProxy* _parameter_733d6c34Proxy__ = nullptr;
            if (_parameter_733d6c34InstanceId__ != 0) {
                _parameter_733d6c34Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_733d6c34InstanceId__, false, _parameter_733d6c34);
                ASSERT((_parameter_733d6c34 != nullptr) && (_parameter_733d6c34Proxy__ != nullptr));
            }

            implementation->Activated(_parameter_733d6c34);

            if (_parameter_733d6c34Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_733d6c34Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_6f18f494InstanceId__ = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_6f18f494{};
            ProxyStub::UnknownProxy* _parameter_6f18f494Proxy__ = nullptr;
            if (_parameter_6f18f494InstanceId__ != 0) {
                _parameter_6f18f494Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_6f18f494InstanceId__, false, _parameter_6f18f494);
                ASSERT((_parameter_6f18f494 != nullptr) && (_parameter_6f18f494Proxy__ != nullptr));
            }

            implementation->Deactivated(_parameter_6f18f494);

            if (_parameter_6f18f494Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_6f18f494Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_e183e961InstanceId__ = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_e183e961{};
            ProxyStub::UnknownProxy* _parameter_e183e961Proxy__ = nullptr;
            if (_parameter_e183e961InstanceId__ != 0) {
                _parameter_e183e961Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_e183e961InstanceId__, false, _parameter_e183e961);
                ASSERT((_parameter_e183e961 != nullptr) && (_parameter_e183e961Proxy__ != nullptr));
            }

            implementation->Terminated(_parameter_e183e961);

            if (_parameter_e183e961Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_e183e961Proxy__, message->Response());
            }
        }
        , nullptr
    ...
    public:
        ...
        void Activated(IRemoteConnection* _parameter_733d6c34) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_733d6c34));
        ...
        void Deactivated(IRemoteConnection* _parameter_6f18f494) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_6f18f494));
        ...
        void Terminated(IRemoteConnection* _parameter_e183e961) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(2));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_e183e961));
