...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeSessionStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const string _parameter_2665a54a = reader.Text();
            const string _parameter_9595d12f = reader.Text();

            Exchange::OCDM_RESULT result = implementation->SetParameter(static_cast<const string&>(_parameter_2665a54a), static_cast<const string&>(_parameter_9595d12f));
    ...
    public:
        ...
        Exchange::OCDM_RESULT SetParameter(const string& _parameter_2665a54a, const string& _parameter_9595d12f) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(13));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_2665a54a);
            writer.Text(_parameter_9595d12f);
