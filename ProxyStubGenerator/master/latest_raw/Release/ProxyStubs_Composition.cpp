...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeCompositionStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                const Exchange::IComposition::ScreenResolution _parameter_bce1eea3 = reader.Number<Exchange::IComposition::ScreenResolution>();

                uint32_t result = implementation->Resolution(_parameter_bce1eea3);
    ...
    static ProxyStub::MethodHandler ExchangeCompositionDisplayStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (Core::RealSize<Exchange::IComposition::ScreenResolution>())) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                const Exchange::IComposition::ScreenResolution _parameter_dad1d75a = reader.Number<Exchange::IComposition::ScreenResolution>();

                uint32_t result = implementation->Resolution(_parameter_dad1d75a);
    ...
    public:
        ...
        uint32_t Resolution(const Exchange::IComposition::ScreenResolution _parameter_bce1eea3) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(3));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Exchange::IComposition::ScreenResolution>(_parameter_bce1eea3);
    ...
    public:
        ...
        uint32_t Resolution(const Exchange::IComposition::ScreenResolution _parameter_dad1d75a) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(3));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Exchange::IComposition::ScreenResolution>(_parameter_dad1d75a);
