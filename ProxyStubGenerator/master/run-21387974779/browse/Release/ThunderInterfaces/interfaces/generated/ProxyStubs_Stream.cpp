...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeStreamStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_db6b40acInstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IStream::ICallback* _parameter_db6b40ac{};
                ProxyStub::UnknownProxy* _parameter_db6b40acProxy__ = nullptr;
                if (_parameter_db6b40acInstanceId__ != 0) {
                    _parameter_db6b40acProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_db6b40acInstanceId__, false, _parameter_db6b40ac);
                    ASSERT((_parameter_db6b40ac != nullptr) && (_parameter_db6b40acProxy__ != nullptr));
                    if ((_parameter_db6b40ac == nullptr) || (_parameter_db6b40acProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Callback(_parameter_db6b40ac);

                if (_parameter_db6b40acProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_db6b40acProxy__, message->Response());
                }
    ...
    public:
        ...
        void Callback(Exchange::IStream::ICallback* _parameter_db6b40ac) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(4));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_db6b40ac));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_db6b40ac), Exchange::IStream::ICallback::ID }, { 0, 0 } };
