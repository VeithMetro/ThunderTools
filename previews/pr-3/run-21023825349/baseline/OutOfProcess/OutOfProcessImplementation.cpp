...
namespace Plugin {
    ...
    class OutOfProcessImplementationTEST : public Exchange::IBrowser, public Exchange::IWebBrowser, public Exchange::IWebBrowserExt, public Exchange::IBrowserResources, public Exchange::IBrowserSecurity, public Exchange::IBrowserScripting, public Exchange::IBrowserCookieJar {
    public:
